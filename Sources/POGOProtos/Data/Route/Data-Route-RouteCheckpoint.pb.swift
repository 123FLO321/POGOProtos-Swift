...
public struct POGOProtos_Data_Route_RouteCheckpoint {
  ...
  public enum OneOf_Type: Equatable {
    ...
    public static func ==(lhs: POGOProtos_Data_Route_RouteCheckpoint.OneOf_Type, rhs: POGOProtos_Data_Route_RouteCheckpoint.OneOf_Type) -> Bool {
      ...
      switch (lhs, rhs) {
      case (.poi, .poi): return {
        guard case .poi(let l) = lhs, case .poi(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.guidepost, .guidepost): return {
        guard case .guidepost(let l) = lhs, case .guidepost(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
  ...
  public struct RouteImage {
    ...
    public enum OneOf_Source: Equatable {
      ...
      public static func ==(lhs: POGOProtos_Data_Route_RouteCheckpoint.RouteImage.OneOf_Source, rhs: POGOProtos_Data_Route_RouteCheckpoint.RouteImage.OneOf_Source) -> Bool {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.imageID, .imageID): return {
          guard case .imageID(let l) = lhs, case .imageID(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.imageContext, .imageContext): return {
          guard case .imageContext(let l) = lhs, case .imageContext(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
...
extension POGOProtos_Data_Route_RouteCheckpoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.type {
    case .poi?: try {
      guard case .poi(let v)? = self.type else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .guidepost?: try {
      guard case .guidepost(let v)? = self.type else { preconditionFailure() }
...
extension POGOProtos_Data_Route_RouteCheckpoint.RouteImage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.source {
    case .imageID?: try {
      guard case .imageID(let v)? = self.source else { preconditionFailure() }
      try visitor.visitSingularStringField(value: v, fieldNumber: 1)
    }()
    case .imageContext?: try {
      guard case .imageContext(let v)? = self.source else { preconditionFailure() }
...
extension POGOProtos_Data_Route_RouteCheckpoint.LocationE6: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.longitudeE6) }()
      default: break
      }
    }
  }
