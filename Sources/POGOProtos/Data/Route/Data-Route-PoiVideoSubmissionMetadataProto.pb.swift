...
public struct POGOProtos_Data_Route_PoiVideoSubmissionMetadataProto {
  ...
  public var playerLevel: Int32 {
    get {return _storage._playerLevel}
...
extension POGOProtos_Data_Route_PoiVideoSubmissionMetadataProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PoiVideoSubmissionMetadataProto"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "poi_id"),
    2: .same(proto: "location"),
    3: .standard(proto: "player_level"),
  ]

  fileprivate class _StorageClass {
    var _poiID: String = String()
    var _location: POGOProtos_Data_Route_RouteCheckpoint.LocationE6? = nil
    var _playerLevel: Int32 = 0
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeSingularInt32Field(value: &_storage._playerLevel)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._playerLevel != 0 {
        try visitor.visitSingularInt32Field(value: _storage._playerLevel, fieldNumber: 3)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: POGOProtos_Data_Route_PoiVideoSubmissionMetadataProto, rhs: POGOProtos_Data_Route_PoiVideoSubmissionMetadataProto) -> Bool {
