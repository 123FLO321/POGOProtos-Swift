...
public struct POGOProtos_Data_Route_PoiVideoSubmissionMetadataProto {
  ...
  public var playerLevel: Int32 = 0
...
extension POGOProtos_Data_Route_PoiVideoSubmissionMetadataProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.playerLevel) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.playerLevel != 0 {
      try visitor.visitSingularInt32Field(value: self.playerLevel, fieldNumber: 3)
    }
