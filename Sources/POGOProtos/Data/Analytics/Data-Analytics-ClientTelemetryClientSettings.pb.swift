...
extension POGOProtos_Data_Analytics_ClientTelemetryClientSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.isUploadEnabled) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.maxUploadSizeInBytes) }()
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.updateIntervalInSec) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self.settingsUpdateIntervalInSec) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self.maxEnvelopeQueueSize) }()
      case 6: try { try decoder.decodeSingularDoubleField(value: &self.samplingProbability) }()
      case 7: try { try decoder.decodeSingularBoolField(value: &self.usePlayerBasedSampling) }()
      case 8: try { try decoder.decodeSingularDoubleField(value: &self.playerHash) }()
      case 9: try { try decoder.decodeSingularStringField(value: &self.playerExternalOmniID) }()
      case 10: try { try decoder.decodeSingularBoolField(value: &self.disableOmniSending) }()
      case 11: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufDouble>.self, value: &self.specialSamplingProbabilityMap) }()
      case 12: try { try decoder.decodeSingularStringField(value: &self.playerExternalUaID) }()
      default: break
      }
    }
  }
