...
extension POGOProtos_Data_Analytics_ClientTelemetryBatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.telemetryScopeID) }()
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self.apiVersion) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.messageVersion) }()
      default: break
      }
    }
  }
