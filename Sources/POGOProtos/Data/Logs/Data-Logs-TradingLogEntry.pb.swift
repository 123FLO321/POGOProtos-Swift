...
extension POGOProtos_Data_Logs_TradingLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._tradeOutPokemon) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._tradeInPokemon) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._rewards) }()
