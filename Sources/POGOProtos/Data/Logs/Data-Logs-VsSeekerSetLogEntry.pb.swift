...
extension POGOProtos_Data_Logs_VsSeekerSetLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.newRank) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.newRating) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.previousRank) }()
      case 6: try { try decoder.decodeSingularFloatField(value: &self.previousRating) }()
      case 7: try { try decoder.decodeSingularInt32Field(value: &self.numberOfWins) }()
      case 8: try { try decoder.decodeSingularInt32Field(value: &self.numberOfBattles) }()
      default: break
      }
    }
  }
