  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularInt32Field(value: &_storage._pokedexNumber) }()
        case 3: try { try decoder.decodeSingularInt32Field(value: &_storage._combatPoints) }()
        case 4: try { try decoder.decodeSingularFixed64Field(value: &_storage._pokemonID) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._pokemonDisplay) }()
        default: break
        }
      }
    }
