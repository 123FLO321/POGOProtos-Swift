...
extension POGOProtos_Data_Logs_FortSearchLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.eggs) }()
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.pokemonEggs) }()
      case 6: try { try decoder.decodeSingularEnumField(value: &self.fortType) }()
      case 7: try { try decoder.decodeRepeatedMessageField(value: &self.awardedItems) }()
      case 8: try { try decoder.decodeRepeatedMessageField(value: &self.bonusItems) }()
      case 9: try { try decoder.decodeRepeatedMessageField(value: &self.teamBonusItems) }()
      case 10: try { try decoder.decodeRepeatedMessageField(value: &self.giftBoxes) }()
      case 11: try { try decoder.decodeRepeatedMessageField(value: &self.stickers) }()
      default: break
      }
    }
  }
