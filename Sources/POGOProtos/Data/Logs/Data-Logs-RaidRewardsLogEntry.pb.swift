...
extension POGOProtos_Data_Logs_RaidRewardsLogEntry.Result: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Data_Logs_RaidRewardsLogEntry.Result] = [
    .unset,
    .success,
  ]
}
...
extension POGOProtos_Data_Logs_RaidRewardsLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBoolField(value: &self.isExclusive) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.items) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.defaultRewards) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.stardust) }()
      case 6: try { try decoder.decodeRepeatedMessageField(value: &self.stickers) }()
      case 7: try { try decoder.decodeSingularBoolField(value: &self.isMega) }()
      case 8: try { try decoder.decodeSingularMessageField(value: &self._megaResource) }()
      default: break
      }
    }
  }
