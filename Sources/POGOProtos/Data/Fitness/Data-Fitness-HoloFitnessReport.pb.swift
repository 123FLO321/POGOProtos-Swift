...
extension POGOProtos_Data_Fitness_HoloFitnessReport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.numEggsHatched) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.numBuddyCandyEarned) }()
      case 3: try { try decoder.decodeSingularDoubleField(value: &self.distanceWalkedKm) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self.weekBucket) }()
      default: break
      }
    }
  }
