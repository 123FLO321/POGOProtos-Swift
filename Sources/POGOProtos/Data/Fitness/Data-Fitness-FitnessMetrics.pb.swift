...
extension POGOProtos_Data_Fitness_FitnessMetrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularDoubleField(value: &self.distanceWalkedMeters) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.stepCount) }()
      case 3: try { try decoder.decodeSingularDoubleField(value: &self.caloriesBurnedKcals) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self.exerciseDurationMi) }()
      case 5: try { try decoder.decodeSingularDoubleField(value: &self.wheelchairDistanceMeters) }()
      case 6: try { try decoder.decodeSingularDoubleField(value: &self.wheelchairPushCount) }()
      default: break
      }
    }
  }
