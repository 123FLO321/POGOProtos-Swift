...
extension POGOProtos_Data_Battle_BattleUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._battleLog) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.battleID) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._activeDefender) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._activeAttacker) }()
      case 5: try { try decoder.decodeSingularEnumField(value: &self.highestFriendshipMilestone) }()
      default: break
      }
    }
  }
