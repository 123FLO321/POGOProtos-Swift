...
extension POGOProtos_Data_Telemetry_PokemonTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularFloatField(value: &self.weightKg) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.heightM) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.pokemonLevel) }()
      default: break
      }
    }
  }
