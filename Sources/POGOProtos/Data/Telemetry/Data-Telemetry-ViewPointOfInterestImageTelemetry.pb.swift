...
public struct POGOProtos_Data_Telemetry_ViewPointOfInterestImageTelemetry {
  ...
  public var wasGymInterior: Bool = false
...
extension POGOProtos_Data_Telemetry_ViewPointOfInterestImageTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ViewPointOfInterestImageTelemetry"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularEnumField(value: &self.fortType) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.inRange) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.wasGymInterior) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.inRange != false {
      try visitor.visitSingularBoolField(value: self.inRange, fieldNumber: 4)
    }
    if self.wasGymInterior != false {
      try visitor.visitSingularBoolField(value: self.wasGymInterior, fieldNumber: 5)
    }
  ...
  public static func ==(lhs: POGOProtos_Data_Telemetry_ViewPointOfInterestImageTelemetry, rhs: POGOProtos_Data_Telemetry_ViewPointOfInterestImageTelemetry) -> Bool {
