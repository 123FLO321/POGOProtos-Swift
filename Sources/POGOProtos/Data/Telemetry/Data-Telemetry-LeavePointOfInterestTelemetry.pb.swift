...
public struct POGOProtos_Data_Telemetry_LeavePointOfInterestTelemetry {
...
extension POGOProtos_Data_Telemetry_LeavePointOfInterestTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".LeavePointOfInterestTelemetry"
  ...
  public static func ==(lhs: POGOProtos_Data_Telemetry_LeavePointOfInterestTelemetry, rhs: POGOProtos_Data_Telemetry_LeavePointOfInterestTelemetry) -> Bool {
