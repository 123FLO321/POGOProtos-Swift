...
extension POGOProtos_Data_Telemetry_LeaveInteractionRangeTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.fortType) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self.clientTimestamp) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.partnerID) }()
      case 6: try { try decoder.decodeSingularInt64Field(value: &self.timeSpent) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.campaignID) }()
      default: break
      }
    }
  }
