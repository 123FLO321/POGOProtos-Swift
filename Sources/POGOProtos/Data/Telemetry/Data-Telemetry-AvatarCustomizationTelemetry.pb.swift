...
extension POGOProtos_Data_Telemetry_AvatarCustomizationTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.avatarCustomizationClickID) }()
      ...
      case 4: try { try decoder.decodeSingularBoolField(value: &self.hasEnoughCoins_p) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.groupName) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.colorChoiceID) }()
      default: break
      }
    }
  }
