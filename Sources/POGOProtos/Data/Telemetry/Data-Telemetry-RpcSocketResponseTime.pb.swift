...
public struct POGOProtos_Data_Telemetry_RpcSocketResponseTime {
...
extension POGOProtos_Data_Telemetry_RpcSocketResponseTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RpcSocketResponseTime"
  ...
  public static func ==(lhs: POGOProtos_Data_Telemetry_RpcSocketResponseTime, rhs: POGOProtos_Data_Telemetry_RpcSocketResponseTime) -> Bool {
