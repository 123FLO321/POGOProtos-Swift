...
extension POGOProtos_Data_Telemetry_MapEventsTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.mapEventClickID) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.fortID) }()
      case 3: try { try decoder.decodeRepeatedInt32Field(value: &self.guardPokemonLevel) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.team) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.isPlayerInRange) }()
      default: break
      }
    }
  }
