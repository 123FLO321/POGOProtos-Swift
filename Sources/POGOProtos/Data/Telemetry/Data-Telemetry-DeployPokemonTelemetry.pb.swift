...
extension POGOProtos_Data_Telemetry_DeployPokemonTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.gymID) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.team) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.defenderCount) }()
      default: break
      }
    }
  }
