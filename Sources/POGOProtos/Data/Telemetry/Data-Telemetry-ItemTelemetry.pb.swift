...
extension POGOProtos_Data_Telemetry_ItemTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.itemUseClickID) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.itemID) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.equipped) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.fromInventory) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.itemIDString) }()
      default: break
      }
    }
  }
