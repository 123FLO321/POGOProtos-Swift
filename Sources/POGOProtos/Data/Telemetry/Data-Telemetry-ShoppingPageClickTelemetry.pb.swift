...
extension POGOProtos_Data_Telemetry_ShoppingPageClickTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.shoppingPageClickID) }()
      case 2: try { try decoder.decodeSingularEnumField(value: &self.shoppingPageClickSource) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.itemSku) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.hasItem_p) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.mlBundleTrackingID) }()
      default: break
      }
    }
  }
