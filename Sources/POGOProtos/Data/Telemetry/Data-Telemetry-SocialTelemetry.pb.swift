...
extension POGOProtos_Data_Telemetry_SocialTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.socialClickID) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.pagesScrolledInFriendsList) }()
      default: break
      }
    }
  }
