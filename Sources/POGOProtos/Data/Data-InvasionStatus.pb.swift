...
// Source: POGOProtos/Data/InvasionStatus.proto
//
...
public struct POGOProtos_Data_InvasionStatus {
...
extension POGOProtos_Data_InvasionStatus.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Data_InvasionStatus.Status] = [
    .unset,
    .success,
    .error,
    .errorFortNotFound,
...
extension POGOProtos_Data_InvasionStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Data_InvasionStatus, rhs: POGOProtos_Data_InvasionStatus) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension POGOProtos_Data_InvasionStatus.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
