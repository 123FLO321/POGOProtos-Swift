...
extension POGOProtos_Data_Combat_CombatChallenge: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.combatLeagueTemplateID) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._challenger) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._opponent) }()
      case 7: try { try decoder.decodeSingularEnumField(value: &self.state) }()
      case 8: try { try decoder.decodeSingularInt64Field(value: &self.createdTimestampMs) }()
      case 10: try { try decoder.decodeSingularStringField(value: &self.combatID) }()
      case 19: try { try decoder.decodeSingularInt64Field(value: &self.expirationTimestampMs) }()
      default: break
      }
    }
  }
