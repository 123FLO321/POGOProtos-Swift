...
public struct POGOProtos_Data_Combat_CombatLog {
  ...
  public var currentVsSeekerSetResults: [POGOProtos_Enums_CombatPlayerFinishState] {
...
extension POGOProtos_Data_Combat_CombatLog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "current_vs_seeker_set_results"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _currentVsSeekerSetResults: [POGOProtos_Enums_CombatPlayerFinishState] = []
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeRepeatedEnumField(value: &_storage._currentVsSeekerSetResults)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._currentVsSeekerSetResults.isEmpty {
        try visitor.visitPackedEnumField(value: _storage._currentVsSeekerSetResults, fieldNumber: 3)
      }
    }
