  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularMessageField(value: &_storage._lifetimeResults) }()
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._currentSeasonResults) }()
        case 4: try { try decoder.decodeRepeatedMessageField(value: &_storage._currentVsSeekerSetResults) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._previousSeasonResults) }()
        default: break
        }
      }
    }
