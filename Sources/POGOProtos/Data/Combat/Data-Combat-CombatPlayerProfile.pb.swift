  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeRepeatedStringField(value: &_storage._combatLeagueTemplateID) }()
        case 4: try { try decoder.decodeSingularFixed64Field(value: &_storage._buddyPokemonID) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._location) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._combatPlayerPreferences) }()
        default: break
        }
      }
    }
...
extension POGOProtos_Data_Combat_CombatPlayerProfile.Location: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularDoubleField(value: &self.latDegree) }()
      case 2: try { try decoder.decodeSingularDoubleField(value: &self.lngDegree) }()
      default: break
      }
    }
  }
