...
public struct POGOProtos_Data_Combat_WithPokemonCategory {
  ...
  public var pokemonIds: [POGOProtos_Enums_PokemonType] = []
...
extension POGOProtos_Data_Combat_WithPokemonCategory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WithPokemonCategory"
  ...
  public static func ==(lhs: POGOProtos_Data_Combat_WithPokemonCategory, rhs: POGOProtos_Data_Combat_WithPokemonCategory) -> Bool {
