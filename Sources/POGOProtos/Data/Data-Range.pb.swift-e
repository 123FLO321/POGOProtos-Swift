...
public struct POGOProtos_Data_Range {
...
extension POGOProtos_Data_Range: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt32Field(value: &self.min)
  ...
  public static func ==(lhs: POGOProtos_Data_Range, rhs: POGOProtos_Data_Range) -> Bool {
