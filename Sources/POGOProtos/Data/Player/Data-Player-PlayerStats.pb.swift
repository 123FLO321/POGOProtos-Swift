...
public struct POGOProtos_Data_Player_PlayerStats {
  ...
  public var numPokemonPurified: Int32 {
    get {return _storage._numPokemonPurified}
    set {_uniqueStorage()._numPokemonPurified = newValue}
  }

  public var numGruntsDefeated: Int32 {
    get {return _storage._numGruntsDefeated}
    set {_uniqueStorage()._numGruntsDefeated = newValue}
  }

  public var numBestBuddies: Int32 {
    get {return _storage._numBestBuddies}
...
extension POGOProtos_Data_Player_PlayerStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularInt64Field(value: &_storage._experience) }()
        case 3: try { try decoder.decodeSingularInt64Field(value: &_storage._prevLevelXp) }()
        case 4: try { try decoder.decodeSingularInt64Field(value: &_storage._nextLevelXp) }()
        case 5: try { try decoder.decodeSingularFloatField(value: &_storage._kmWalked) }()
        case 6: try { try decoder.decodeSingularInt32Field(value: &_storage._pokemonsEncountered) }()
        case 7: try { try decoder.decodeSingularInt32Field(value: &_storage._uniquePokedexEntries) }()
        case 8: try { try decoder.decodeSingularInt32Field(value: &_storage._pokemonsCaptured) }()
        case 9: try { try decoder.decodeSingularInt32Field(value: &_storage._evolutions) }()
        case 10: try { try decoder.decodeSingularInt32Field(value: &_storage._pokeStopVisits) }()
        case 11: try { try decoder.decodeSingularInt32Field(value: &_storage._pokeballsThrown) }()
        case 12: try { try decoder.decodeSingularInt32Field(value: &_storage._eggsHatched) }()
        case 13: try { try decoder.decodeSingularInt32Field(value: &_storage._bigMagikarpCaught) }()
        case 14: try { try decoder.decodeSingularInt32Field(value: &_storage._battleAttackWon) }()
        case 15: try { try decoder.decodeSingularInt32Field(value: &_storage._battleAttackTotal) }()
        case 16: try { try decoder.decodeSingularInt32Field(value: &_storage._battleDefendedWon) }()
        case 17: try { try decoder.decodeSingularInt32Field(value: &_storage._battleTrainingWon) }()
        case 18: try { try decoder.decodeSingularInt32Field(value: &_storage._battleTrainingTotal) }()
        case 19: try { try decoder.decodeSingularInt32Field(value: &_storage._prestigeRaisedTotal) }()
        case 20: try { try decoder.decodeSingularInt32Field(value: &_storage._prestigeDroppedTotal) }()
        case 21: try { try decoder.decodeSingularInt32Field(value: &_storage._pokemonDeployed) }()
        case 22: try { try decoder.decodeRepeatedInt32Field(value: &_storage._pokemonCaughtByType) }()
        case 23: try { try decoder.decodeSingularInt32Field(value: &_storage._smallRattataCaught) }()
        case 24: try { try decoder.decodeSingularDoubleField(value: &_storage._usedKmPool) }()
        case 25: try { try decoder.decodeSingularInt64Field(value: &_storage._lastKmRefillMs) }()
        case 26: try { try decoder.decodeSingularInt32Field(value: &_storage._numRaidBattleWon) }()
        case 27: try { try decoder.decodeSingularInt32Field(value: &_storage._numRaidBattleTotal) }()
        case 28: try { try decoder.decodeSingularInt32Field(value: &_storage._numLegendaryBattleWon) }()
        case 29: try { try decoder.decodeSingularInt32Field(value: &_storage._numLegendaryBattleTotal) }()
        case 30: try { try decoder.decodeSingularInt32Field(value: &_storage._numBerriesFed) }()
        case 31: try { try decoder.decodeSingularInt64Field(value: &_storage._totalDefendedMs) }()
        case 32: try { try decoder.decodeRepeatedEnumField(value: &_storage._eventBadges) }()
        case 33: try { try decoder.decodeSingularFloatField(value: &_storage._kmWalkedPastActiveDay) }()
        case 34: try { try decoder.decodeSingularInt32Field(value: &_storage._numChallengeQuestsCompleted) }()
        case 35: try { try decoder.decodeSingularInt32Field(value: &_storage._numTrades) }()
        case 36: try { try decoder.decodeSingularInt32Field(value: &_storage._numMaxLevelFriends) }()
        case 37: try { try decoder.decodeSingularInt64Field(value: &_storage._tradeAccumulatedDistanceKm) }()
        case 38: try { try decoder.decodeSingularInt64Field(value: &_storage._fitnessReportLastCheckBucket) }()
        case 39: try { try decoder.decodeSingularMessageField(value: &_storage._combatStats) }()
        case 40: try { try decoder.decodeSingularInt32Field(value: &_storage._numNpcCombatsWon) }()
        case 41: try { try decoder.decodeSingularInt32Field(value: &_storage._numNpcCombatsTotal) }()
        case 42: try { try decoder.decodeSingularInt32Field(value: &_storage._numPhotobombSeen) }()
        case 43: try { try decoder.decodeSingularInt32Field(value: &_storage._numPokemonPurified) }()
        case 44: try { try decoder.decodeSingularInt32Field(value: &_storage._numGruntsDefeated) }()
        case 47: try { try decoder.decodeSingularInt32Field(value: &_storage._numBestBuddies) }()
        case 48: try { try decoder.decodeSingularInt32Field(value: &_storage._levelCap) }()
        case 49: try { try decoder.decodeSingularInt32Field(value: &_storage._sevenDayStreaks) }()
        case 50: try { try decoder.decodeSingularInt32Field(value: &_storage._uniqueRaidBossesDefeated) }()
        case 51: try { try decoder.decodeSingularInt32Field(value: &_storage._uniquePokestopsVisited) }()
        case 52: try { try decoder.decodeSingularInt32Field(value: &_storage._raidsWonWithFriends) }()
        case 53: try { try decoder.decodeSingularInt32Field(value: &_storage._pokemonCaughtAtYourLures) }()
        case 54: try { try decoder.decodeSingularInt32Field(value: &_storage._numWayfarerAgreement) }()
        case 55: try { try decoder.decodeSingularInt64Field(value: &_storage._wayfarerAgreementUpdateMs) }()
        case 56: try { try decoder.decodeSingularInt32Field(value: &_storage._numTotalMegaEvolutions) }()
        case 57: try { try decoder.decodeSingularInt32Field(value: &_storage._numUniqueMegaEvolutions) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._numPokemonPurified != 0 {
        try visitor.visitSingularInt32Field(value: _storage._numPokemonPurified, fieldNumber: 43)
      }
      if _storage._numGruntsDefeated != 0 {
        try visitor.visitSingularInt32Field(value: _storage._numGruntsDefeated, fieldNumber: 44)
      }
