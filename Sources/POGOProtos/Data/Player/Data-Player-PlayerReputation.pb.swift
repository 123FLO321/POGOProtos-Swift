...
extension POGOProtos_Data_Player_PlayerReputation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.accountAgeMs) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.playerLevel) }()
      case 3: try { try decoder.decodeRepeatedEnumField(value: &self.cheatReputation) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.isMinor) }()
      default: break
      }
    }
  }
