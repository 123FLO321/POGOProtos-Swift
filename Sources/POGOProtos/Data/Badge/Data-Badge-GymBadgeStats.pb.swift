...
extension POGOProtos_Data_Badge_GymBadgeStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self.totalTimeDefendedMs) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.numBattlesWon) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.numBerriesFed) }()
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.numDeploys) }()
      case 5: try { try decoder.decodeSingularUInt32Field(value: &self.numBattlesLost) }()
      case 15: try { try decoder.decodeRepeatedMessageField(value: &self.gymBattles) }()
      default: break
      }
    }
  }
