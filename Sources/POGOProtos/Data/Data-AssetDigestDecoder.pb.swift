...
// Source: POGOProtos/Data/AssetDigestDecoder.proto
//
...
public struct POGOProtos_Data_AssetDigestDecoder {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var digest: [POGOProtos_Data_AssetDigestDecoder.AssetDigestEntry] = []

  public var timestampMs: UInt64 = 0

  public var result: POGOProtos_Data_AssetDigestDecoder.Result = .unset
...
extension POGOProtos_Data_AssetDigestDecoder.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Data_AssetDigestDecoder.Result] = [
    .unset,
    .success,
    .page,
    .retry,
...
extension POGOProtos_Data_AssetDigestDecoder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AssetDigestDecoder"
  ...
  public static func ==(lhs: POGOProtos_Data_AssetDigestDecoder, rhs: POGOProtos_Data_AssetDigestDecoder) -> Bool {
...
extension POGOProtos_Data_AssetDigestDecoder.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
...
extension POGOProtos_Data_AssetDigestDecoder.AssetDigestEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Data_AssetDigestDecoder.protoMessageName + ".AssetDigestEntry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Data_AssetDigestDecoder.AssetDigestEntry, rhs: POGOProtos_Data_AssetDigestDecoder.AssetDigestEntry) -> Bool {
