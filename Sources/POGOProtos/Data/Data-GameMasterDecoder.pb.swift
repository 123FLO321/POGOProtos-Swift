...
// Source: POGOProtos/Data/GameMasterDecoder.proto
//
...
public struct POGOProtos_Data_GameMasterDecoder {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Data_GameMasterDecoder.Result = .unset

  public var template: [POGOProtos_Data_GameMasterDecoder.ClientGameMasterTemplate] = []
...
extension POGOProtos_Data_GameMasterDecoder.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Data_GameMasterDecoder.Result] = [
    .unset,
    .complete,
    .moreResults,
    .batchIDNotLive,
...
extension POGOProtos_Data_GameMasterDecoder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GameMasterDecoder"
  ...
  public static func ==(lhs: POGOProtos_Data_GameMasterDecoder, rhs: POGOProtos_Data_GameMasterDecoder) -> Bool {
...
extension POGOProtos_Data_GameMasterDecoder.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
...
extension POGOProtos_Data_GameMasterDecoder.ClientGameMasterTemplate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Data_GameMasterDecoder.protoMessageName + ".ClientGameMasterTemplate"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Data_GameMasterDecoder.ClientGameMasterTemplate, rhs: POGOProtos_Data_GameMasterDecoder.ClientGameMasterTemplate) -> Bool {
