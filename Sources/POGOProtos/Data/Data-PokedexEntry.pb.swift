  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularInt32Field(value: &_storage._timesEncountered)
        case 3: try decoder.decodeSingularInt32Field(value: &_storage._timesCaptured)
        case 4: try decoder.decodeSingularInt32Field(value: &_storage._evolutionStonePieces)
        case 5: try decoder.decodeSingularInt32Field(value: &_storage._evolutionStones)
        case 6: try decoder.decodeRepeatedEnumField(value: &_storage._capturedCostumes)
        case 7: try decoder.decodeRepeatedEnumField(value: &_storage._capturedForms)
        case 8: try decoder.decodeRepeatedEnumField(value: &_storage._capturedGenders)
        case 9: try decoder.decodeSingularBoolField(value: &_storage._capturedShiny)
        case 10: try decoder.decodeRepeatedEnumField(value: &_storage._encounteredCostumes)
        case 11: try decoder.decodeRepeatedEnumField(value: &_storage._encounteredForms)
        case 12: try decoder.decodeRepeatedEnumField(value: &_storage._encounteredGenders)
        case 13: try decoder.decodeSingularBoolField(value: &_storage._encounteredShiny)
        case 14: try decoder.decodeSingularInt32Field(value: &_storage._timesLuckyReceived)
        case 15: try decoder.decodeSingularInt32Field(value: &_storage._timesPurified)
        case 16: try decoder.decodeRepeatedMessageField(value: &_storage._tempEvoData)
        case 17: try decoder.decodeRepeatedEnumField(value: &_storage._capturedShinyForms)
        default: break
        }
      }
    }
...
extension POGOProtos_Data_PokedexEntry.TempEvoData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularInt32Field(value: &self.timesObtained)
      case 4: try decoder.decodeRepeatedEnumField(value: &self.gendersEncountered)
      case 5: try decoder.decodeRepeatedEnumField(value: &self.gendersObtained)
      default: break
      }
    }
  }
