...
extension POGOProtos_Data_News_CurrentNews: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.newsArticles) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.newsStringsURL) }()
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.lastUpdatedTimestamp) }()
      default: break
      }
    }
  }
