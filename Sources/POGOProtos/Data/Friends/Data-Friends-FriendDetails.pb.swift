...
public struct POGOProtos_Data_Friends_FriendDetails {
  ...
  public var friendVisibleData: Data = Data()
...
extension POGOProtos_Data_Friends_FriendDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBytesField(value: &self.friendVisibleData) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.score) }()
      case 4: try { try decoder.decodeSingularBytesField(value: &self.dataWithMe) }()
      case 5: try { try decoder.decodeSingularEnumField(value: &self.onlineStatus) }()
      default: break
      }
    }
  }
