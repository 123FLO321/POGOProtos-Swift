...
extension POGOProtos_Data_Friends_OutgoingFriendInvite: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.createdMs) }()
      case 4: try { try decoder.decodeSingularEnumField(value: &self.invitationType) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.fullName) }()
      case 6: try { try decoder.decodeRepeatedEnumField(value: &self.nianticSocialGraphAppKeys) }()
      default: break
      }
    }
  }
