...
public struct POGOProtos_Data_Gym_GymBattle {
  ...
  public var incrementedGymBattleFriends: Bool = false
...
extension POGOProtos_Data_Gym_GymBattle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GymBattle"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.battleID) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.completedMs) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.incrementedGymBattleFriends) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: POGOProtos_Data_Gym_GymBattle, rhs: POGOProtos_Data_Gym_GymBattle) -> Bool {
