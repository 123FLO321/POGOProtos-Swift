...
extension POGOProtos_Data_Titan_AvailableSubmissionsPerSubmissionType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.playerSubmissionType) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.submissionsLeft) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.minPlayerLevel) }()
      ...
      case 8: try { try decoder.decodeRepeatedStringField(value: &self.blacklistedDeviceID) }()
      case 9: try { try decoder.decodeSingularBoolField(value: &self.isWhitelistedUser) }()
      default: break
      }
    }
  }
