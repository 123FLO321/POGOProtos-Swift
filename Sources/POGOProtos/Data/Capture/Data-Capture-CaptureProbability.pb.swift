...
extension POGOProtos_Data_Capture_CaptureProbability: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedEnumField(value: &self.pokeballType) }()
      case 2: try { try decoder.decodeRepeatedFloatField(value: &self.captureProbability) }()
      case 12: try { try decoder.decodeSingularDoubleField(value: &self.reticleDifficultyScale) }()
      default: break
      }
    }
  }
