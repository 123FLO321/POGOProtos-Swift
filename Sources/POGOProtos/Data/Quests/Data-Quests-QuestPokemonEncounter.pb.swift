...
extension POGOProtos_Data_Quests_QuestPokemonEncounter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularEnumField(value: &self.encounterType) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.isHiddenDitto) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._ditto) }()
      default: break
      }
    }
  }
