...
extension POGOProtos_Data_Buddy_BuddyStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularFloatField(value: &self.kmWalked) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.berriesFed) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.communication) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.battles) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.photos) }()
      case 6: try { try decoder.decodeSingularInt32Field(value: &self.newVisits) }()
      default: break
      }
    }
  }
