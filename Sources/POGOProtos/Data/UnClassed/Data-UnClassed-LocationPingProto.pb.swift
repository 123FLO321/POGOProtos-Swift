...
public struct POGOProtos_Data_UnClassed_LocationPing {
...
extension POGOProtos_Data_UnClassed_LocationPing.PingReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Data_UnClassed_LocationPing.PingReason] = [
    .unset,
    .entranceEvent,
    .exitEvent,
    .dwellEvent,
...
extension POGOProtos_Data_UnClassed_LocationPing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".LocationPing"
  ...
  public static func ==(lhs: POGOProtos_Data_UnClassed_LocationPing, rhs: POGOProtos_Data_UnClassed_LocationPing) -> Bool {
...
extension POGOProtos_Data_UnClassed_LocationPing.PingReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
