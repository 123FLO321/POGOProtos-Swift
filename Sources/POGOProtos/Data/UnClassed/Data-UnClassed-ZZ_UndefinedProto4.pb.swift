...
extension POGOProtos_Data_UnClassed_ZZ_UndefinedProto4: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.zz4ObStringValue0)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.zz4ObListValue0)
      default: break
      }
    }
  }
...
extension POGOProtos_Data_UnClassed_ZZ_UndefinedProto4.ZZ_UndefinedProto2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt64Field(value: &self.zz2ObInt64Value)
      case 2: try decoder.decodeSingularDoubleField(value: &self.zz2ObDoubleValue0)
      case 3: try decoder.decodeSingularDoubleField(value: &self.zz2ObDoubleValue1)
      default: break
      }
    }
  }
