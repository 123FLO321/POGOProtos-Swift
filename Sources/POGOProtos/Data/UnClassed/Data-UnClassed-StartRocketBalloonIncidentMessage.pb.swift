...
public struct POGOProtos_Data_UnClassed_StartRocketBalloonIncidenMessage {
...
extension POGOProtos_Data_UnClassed_StartRocketBalloonIncidenMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".StartRocketBalloonIncidenMessage"
  ...
  public static func ==(lhs: POGOProtos_Data_UnClassed_StartRocketBalloonIncidenMessage, rhs: POGOProtos_Data_UnClassed_StartRocketBalloonIncidenMessage) -> Bool {
