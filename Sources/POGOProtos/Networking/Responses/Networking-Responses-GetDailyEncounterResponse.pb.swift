  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try { try decoder.decodeSingularDoubleField(value: &_storage._lng) }()
        case 5: try { try decoder.decodeSingularStringField(value: &_storage._encounterLocation) }()
        case 6: try { try decoder.decodeSingularFixed64Field(value: &_storage._encounterID) }()
        case 7: try { try decoder.decodeSingularInt64Field(value: &_storage._disappearTimeMs) }()
        case 8: try { try decoder.decodeSingularMessageField(value: &_storage._pokemonDisplay) }()
        default: break
        }
      }
    }
