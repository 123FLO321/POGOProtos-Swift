...
public struct POGOProtos_Networking_Responses_UseItemPotionResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Responses_UseItemPotionResponse.Result = .unset
...
extension POGOProtos_Networking_Responses_UseItemPotionResponse.Result: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Networking_Responses_UseItemPotionResponse.Result] = [
    .unset,
    .success,
    .errorNoPokemon,
    .errorCannotUse,
...
extension POGOProtos_Networking_Responses_UseItemPotionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UseItemPotionResponse"
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_UseItemPotionResponse, rhs: POGOProtos_Networking_Responses_UseItemPotionResponse) -> Bool {
