...
public struct POGOProtos_Networking_Responses_UpdateTradingResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Responses_UpdateTradingResponse.Result = .unset
...
extension POGOProtos_Networking_Responses_UpdateTradingResponse.Result: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Networking_Responses_UpdateTradingResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
    .errorFriendNotFound,
...
extension POGOProtos_Networking_Responses_UpdateTradingResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UpdateTradingResponse"
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_UpdateTradingResponse, rhs: POGOProtos_Networking_Responses_UpdateTradingResponse) -> Bool {
