...
public struct POGOProtos_Networking_Responses_AcceptCombatChallengeResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Responses_AcceptCombatChallengeResponse.Result {
  ...
  public enum Result: SwiftProtobuf.Enum {
    ...
    case errorOpponentNotInRange // = 7
    case errorAlreadyTimedout // = 8
    case errorAlreadyCancelled // = 9
    case errorAccessDenied // = 10
    ...
    public init?(rawValue: Int) {
      ...
      case 7: self = .errorOpponentNotInRange
      case 8: self = .errorAlreadyTimedout
      case 9: self = .errorAlreadyCancelled
      case 10: self = .errorAccessDenied
    ...
    public var rawValue: Int {
      ...
      case .errorOpponentNotInRange: return 7
      case .errorAlreadyTimedout: return 8
      case .errorAlreadyCancelled: return 9
      case .errorAccessDenied: return 10
...
extension POGOProtos_Networking_Responses_AcceptCombatChallengeResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Responses_AcceptCombatChallengeResponse.Result] = [
    .unset,
    .success,
...
extension POGOProtos_Networking_Responses_AcceptCombatChallengeResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AcceptCombatChallengeResponse"
  ...
  fileprivate class _StorageClass {
    var _result: POGOProtos_Networking_Responses_AcceptCombatChallengeResponse.Result = .unset
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_AcceptCombatChallengeResponse, rhs: POGOProtos_Networking_Responses_AcceptCombatChallengeResponse) -> Bool {
...
extension POGOProtos_Networking_Responses_AcceptCombatChallengeResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
    ...
    7: .same(proto: "ERROR_OPPONENT_NOT_IN_RANGE"),
    8: .same(proto: "ERROR_ALREADY_TIMEDOUT"),
    9: .same(proto: "ERROR_ALREADY_CANCELLED"),
    10: .same(proto: "ERROR_ACCESS_DENIED"),
  ]
}
