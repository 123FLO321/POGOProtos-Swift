...
extension POGOProtos_Networking_Responses_DownloadRemoteConfigVersionResponse.Result: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Networking_Responses_DownloadRemoteConfigVersionResponse.Result] = [
    .unset,
    .success,
  ]
}
...
extension POGOProtos_Networking_Responses_DownloadRemoteConfigVersionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.itemTemplatesTimestampMs) }()
      case 3: try { try decoder.decodeSingularUInt64Field(value: &self.assetDigestTimestampMs) }()
      case 4: try { try decoder.decodeRepeatedUInt32Field(value: &self.experimentID) }()
      default: break
      }
    }
  }
