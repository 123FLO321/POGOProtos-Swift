...
public struct POGOProtos_Networking_Responses_GetCombatResultsResponse {
  ...
  public var result: POGOProtos_Networking_Responses_GetCombatResultsResponse.Result {
  ...
  public var friendLevelUp: POGOProtos_Data_Friends_LeveledUpFriends {
    get {return _storage._friendLevelUp ?? POGOProtos_Data_Friends_LeveledUpFriends()}
    set {_uniqueStorage()._friendLevelUp = newValue}
  }
  /// Returns true if `friendLevelUp` has been explicitly set.
  public var hasFriendLevelUp: Bool {return _storage._friendLevelUp != nil}
  /// Clears the value of `friendLevelUp`. Subsequent reads from it will return its default value.
  public mutating func clearFriendLevelUp() {_uniqueStorage()._friendLevelUp = nil}

  public var numberRewardedBattlesToday: Int32 {
    get {return _storage._numberRewardedBattlesToday}
    set {_uniqueStorage()._numberRewardedBattlesToday = newValue}
  }

  public var combatPlayerFinishState: POGOProtos_Enums_CombatPlayerFinishState {
    get {return _storage._combatPlayerFinishState}
    set {_uniqueStorage()._combatPlayerFinishState = newValue}
  }

  public var combatRematch: POGOProtos_Networking_Responses_GetCombatResultsResponse.CombatRematch {
    get {return _storage._combatRematch ?? POGOProtos_Networking_Responses_GetCombatResultsResponse.CombatRematch()}
    set {_uniqueStorage()._combatRematch = newValue}
  }
  /// Returns true if `combatRematch` has been explicitly set.
  public var hasCombatRematch: Bool {return _storage._combatRematch != nil}
  /// Clears the value of `combatRematch`. Subsequent reads from it will return its default value.
  public mutating func clearCombatRematch() {_uniqueStorage()._combatRematch = nil}
...
extension POGOProtos_Networking_Responses_GetCombatResultsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _result: POGOProtos_Networking_Responses_GetCombatResultsResponse.Result = .unset
    var _rewardStatus: POGOProtos_Enums_CombatRewardStatus = .unsetRewardStatus
    var _rewards: POGOProtos_Inventory_Loot? = nil
    var _friendLevelUp: POGOProtos_Data_Friends_LeveledUpFriends? = nil
    var _numberRewardedBattlesToday: Int32 = 0
    var _combatPlayerFinishState: POGOProtos_Enums_CombatPlayerFinishState = .winner
    var _combatRematch: POGOProtos_Networking_Responses_GetCombatResultsResponse.CombatRematch? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _friendLevelUp = source._friendLevelUp
      _numberRewardedBattlesToday = source._numberRewardedBattlesToday
      _combatPlayerFinishState = source._combatPlayerFinishState
      _combatRematch = source._combatRematch
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try decoder.decodeSingularMessageField(value: &_storage._friendLevelUp)
        case 5: try decoder.decodeSingularInt32Field(value: &_storage._numberRewardedBattlesToday)
        case 6: try decoder.decodeSingularEnumField(value: &_storage._combatPlayerFinishState)
        case 7: try decoder.decodeSingularMessageField(value: &_storage._combatRematch)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._friendLevelUp {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
      }
      if _storage._numberRewardedBattlesToday != 0 {
        try visitor.visitSingularInt32Field(value: _storage._numberRewardedBattlesToday, fieldNumber: 5)
      }
      if _storage._combatPlayerFinishState != .winner {
        try visitor.visitSingularEnumField(value: _storage._combatPlayerFinishState, fieldNumber: 6)
      }
      if let v = _storage._combatRematch {
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_GetCombatResultsResponse, rhs: POGOProtos_Networking_Responses_GetCombatResultsResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._friendLevelUp != rhs_storage._friendLevelUp {return false}
        if _storage._numberRewardedBattlesToday != rhs_storage._numberRewardedBattlesToday {return false}
        if _storage._combatPlayerFinishState != rhs_storage._combatPlayerFinishState {return false}
        if _storage._combatRematch != rhs_storage._combatRematch {return false}
        return true
      }
