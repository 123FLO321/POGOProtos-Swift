...
public struct POGOProtos_Networking_Responses_Game_GamePing_Responses_PingResponse {
...
fileprivate let _protobuf_package = "POGOProtos.Networking.Responses.Game.GamePing.Responses"

extension POGOProtos_Networking_Responses_Game_GamePing_Responses_PingResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.userInfo) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.serverInfo) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.randomResponseBytes) }()
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_Game_GamePing_Responses_PingResponse, rhs: POGOProtos_Networking_Responses_Game_GamePing_Responses_PingResponse) -> Bool {
