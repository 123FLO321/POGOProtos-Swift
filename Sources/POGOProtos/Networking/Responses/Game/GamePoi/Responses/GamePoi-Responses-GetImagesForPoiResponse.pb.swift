...
extension POGOProtos_Networking_Responses_Game_GamePoi_Responses_GetImagesForPoiResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.photoGalleryPoiImages)
      default: break
      }
    }
  }
...
extension POGOProtos_Networking_Responses_Game_GamePoi_Responses_GetImagesForPoiResponse.GameClientPhotoGalleryPoiImage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.poiID)
      case 3: try decoder.decodeSingularStringField(value: &self.submitterCodename)
      case 4: try decoder.decodeSingularStringField(value: &self.imageURL)
      case 5: try decoder.decodeSingularInt64Field(value: &self.creationTimestampMs)
      case 6: try decoder.decodeSingularBoolField(value: &self.hasPlayerVoted_p)
      case 7: try decoder.decodeSingularInt32Field(value: &self.numVotesFromGame)
      default: break
      }
    }
  }
