...
extension POGOProtos_Networking_Responses_Game_GamePoi_Responses_GetARMappingSettingsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBoolField(value: &self.isClientScanValidationEnabled)
      case 2: try decoder.decodeRepeatedStringField(value: &self.clientScanValidationBlockedOs)
      case 3: try decoder.decodeRepeatedStringField(value: &self.clientScanValidationBlockedDeviceID)
      default: break
      }
    }
  }
