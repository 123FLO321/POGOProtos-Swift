...
extension POGOProtos_Networking_Responses_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,POGOProtos_Data_Grapeshot_GrapeshotUploadingData>.self, value: &self.fileContextToGrapeshotData) }()
      default: break
      }
    }
  }
