...
public struct POGOProtos_Networking_Responses_Platform_Responses_GetInventoryResponse {
...
extension POGOProtos_Networking_Responses_Platform_Responses_GetInventoryResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._inventoryDelta) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_Platform_Responses_GetInventoryResponse, rhs: POGOProtos_Networking_Responses_Platform_Responses_GetInventoryResponse) -> Bool {
