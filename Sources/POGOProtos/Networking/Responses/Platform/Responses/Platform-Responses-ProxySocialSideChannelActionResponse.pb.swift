...
public struct POGOProtos_Networking_Responses_Platform_Responses_ProxySocialSideChannelActionResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var status: POGOProtos_Networking_Responses_Platform_Responses_ProxySocialSideChannelActionResponse.Status = .unset
...
extension POGOProtos_Networking_Responses_Platform_Responses_ProxySocialSideChannelActionResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Responses_Platform_Responses_ProxySocialSideChannelActionResponse.Status] = [
    .unset,
    .completed,
...
extension POGOProtos_Networking_Responses_Platform_Responses_ProxySocialSideChannelActionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_Platform_Responses_ProxySocialSideChannelActionResponse, rhs: POGOProtos_Networking_Responses_Platform_Responses_ProxySocialSideChannelActionResponse) -> Bool {
...
extension POGOProtos_Networking_Responses_Platform_Responses_ProxySocialSideChannelActionResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
