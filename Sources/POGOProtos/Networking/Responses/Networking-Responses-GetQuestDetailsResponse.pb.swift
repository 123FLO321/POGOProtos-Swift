...
public struct POGOProtos_Networking_Responses_GetQuestDetailsResponse {
  ...
  public enum Status: SwiftProtobuf.Enum {
    ...
    public init?(rawValue: Int) {
      ...
      case 3: self = .errorInvalidDisplay
    ...
    public var rawValue: Int {
      ...
      case .errorInvalidDisplay: return 3
...
extension POGOProtos_Networking_Responses_GetQuestDetailsResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Responses_GetQuestDetailsResponse.Status] = [
    .unset,
    .success,
    .errorQuestNotFound,
    .errorInvalidDisplay,
...
extension POGOProtos_Networking_Responses_GetQuestDetailsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.quests) }()
      default: break
      }
    }
  }
...
extension POGOProtos_Networking_Responses_GetQuestDetailsResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "ERROR_INVALID_DISPLAY"),
  ]
}
