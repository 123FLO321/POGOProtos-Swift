...
extension POGOProtos_Networking_Responses_BelugaTransactionCompleteResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._lootAwarded) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._belugaFinalizeResponse) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.bucketsUntilWeeklyAward) }()
      default: break
      }
    }
  }
