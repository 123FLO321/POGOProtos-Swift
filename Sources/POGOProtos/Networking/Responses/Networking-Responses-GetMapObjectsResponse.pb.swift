...
extension POGOProtos_Networking_Responses_GetMapObjectsResponse.TimeOfDay: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Networking_Responses_GetMapObjectsResponse.TimeOfDay] = [
    .none,
    .day,
    .night,
  ]
...
extension POGOProtos_Networking_Responses_GetMapObjectsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.mapCells) }()
      case 2: try { try decoder.decodeSingularEnumField(value: &self.status) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self.timeOfDay) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.clientWeather) }()
      default: break
      }
    }
  }
