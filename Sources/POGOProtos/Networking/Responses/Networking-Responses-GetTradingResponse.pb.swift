...
public struct POGOProtos_Networking_Responses_GetTradingResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Responses_GetTradingResponse.Result {
...
extension POGOProtos_Networking_Responses_GetTradingResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Responses_GetTradingResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
    .errorFriendNotFound,
...
extension POGOProtos_Networking_Responses_GetTradingResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetTradingResponse"
  ...
  fileprivate class _StorageClass {
    var _result: POGOProtos_Networking_Responses_GetTradingResponse.Result = .unset
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_GetTradingResponse, rhs: POGOProtos_Networking_Responses_GetTradingResponse) -> Bool {
...
extension POGOProtos_Networking_Responses_GetTradingResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
