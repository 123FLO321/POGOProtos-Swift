...
public struct POGOProtos_Networking_Responses_AttackGymResponse {
  ...
  public var result: POGOProtos_Networking_Responses_AttackGymResponse.Result {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._battleLog) }()
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._battleID) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._activeDefender) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._activeAttacker) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._battleUpdate) }()
        default: break
        }
      }
    }
