...
public struct POGOProtos_Networking_Responses_Social_GiftDetailsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Responses_Social_GiftDetailsResponse.Result = .unset
...
extension POGOProtos_Networking_Responses_Social_GiftDetailsResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Responses_Social_GiftDetailsResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
...
extension POGOProtos_Networking_Responses_Social_GiftDetailsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_Social_GiftDetailsResponse, rhs: POGOProtos_Networking_Responses_Social_GiftDetailsResponse) -> Bool {
...
extension POGOProtos_Networking_Responses_Social_GiftDetailsResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
