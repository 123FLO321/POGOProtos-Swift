...
public struct POGOProtos_Networking_Responses_Social_Responses_UpdateNotificationResponse {
...
extension POGOProtos_Networking_Responses_Social_Responses_UpdateNotificationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UpdateNotificationResponse"
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_Social_Responses_UpdateNotificationResponse, rhs: POGOProtos_Networking_Responses_Social_Responses_UpdateNotificationResponse) -> Bool {
