...
extension POGOProtos_Networking_Responses_Social_SaveSocialPlayerSettingsResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Responses_Social_SaveSocialPlayerSettingsResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
  ]
