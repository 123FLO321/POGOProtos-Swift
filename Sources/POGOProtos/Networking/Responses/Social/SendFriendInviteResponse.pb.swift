...
public struct POGOProtos_Networking_Responses_Social_SendFriendInviteResponse {
  ...
  public var result: POGOProtos_Networking_Responses_Social_SendFriendInviteResponse.Result = .unset
...
extension POGOProtos_Networking_Responses_Social_SendFriendInviteResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_Social_SendFriendInviteResponse, rhs: POGOProtos_Networking_Responses_Social_SendFriendInviteResponse) -> Bool {
