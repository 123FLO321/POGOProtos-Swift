...
public struct POGOProtos_Networking_Responses_Social_GetFriendsListResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Responses_Social_GetFriendsListResponse.Result = .unset

  public var friend: [POGOProtos_Networking_Responses_Social_GetFriendsListResponse.Friend] = []
...
extension POGOProtos_Networking_Responses_Social_GetFriendsListResponse.Result: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Networking_Responses_Social_GetFriendsListResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
  ]
...
extension POGOProtos_Networking_Responses_Social_GetFriendsListResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetFriendsListResponse"
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_Social_GetFriendsListResponse, rhs: POGOProtos_Networking_Responses_Social_GetFriendsListResponse) -> Bool {
...
extension POGOProtos_Networking_Responses_Social_GetFriendsListResponse.Friend: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Responses_Social_GetFriendsListResponse.protoMessageName + ".Friend"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_Social_GetFriendsListResponse.Friend, rhs: POGOProtos_Networking_Responses_Social_GetFriendsListResponse.Friend) -> Bool {
