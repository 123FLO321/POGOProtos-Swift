...
public struct POGOProtos_Networking_Responses_StartIncidentResponse {
  ...
  public struct ClientIncident {
    ...
    public var context: POGOProtos_Enums_EnumWrapper.InvasionContext {
    ...
    public struct ClientIncidentStep {
      ...
      public enum OneOf_ClientIncidentStep: Equatable {
        ...
        public static func ==(lhs: POGOProtos_Networking_Responses_StartIncidentResponse.ClientIncident.ClientIncidentStep.OneOf_ClientIncidentStep, rhs: POGOProtos_Networking_Responses_StartIncidentResponse.ClientIncident.ClientIncidentStep.OneOf_ClientIncidentStep) -> Bool {
          ...
          switch (lhs, rhs) {
          case (.invasionBattle, .invasionBattle): return {
            guard case .invasionBattle(let l) = lhs, case .invasionBattle(let r) = rhs else { preconditionFailure() }
            return l == r
          }()
          case (.invasionEncounter, .invasionEncounter): return {
            guard case .invasionEncounter(let l) = lhs, case .invasionEncounter(let r) = rhs else { preconditionFailure() }
            return l == r
          }()
          case (.pokestopDialogue, .pokestopDialogue): return {
            guard case .pokestopDialogue(let l) = lhs, case .pokestopDialogue(let r) = rhs else { preconditionFailure() }
            return l == r
          }()
...
extension POGOProtos_Networking_Responses_StartIncidentResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._incident) }()
      default: break
      }
    }
  }
...
extension POGOProtos_Networking_Responses_StartIncidentResponse.ClientIncident: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _context: POGOProtos_Enums_EnumWrapper.InvasionContext = .pokestopIncident
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularStringField(value: &_storage._incidentID) }()
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._fortID) }()
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._fortName) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._pokestopImageUri) }()
        case 5: try { try decoder.decodeSingularInt32Field(value: &_storage._currentStep) }()
        case 6: try { try decoder.decodeRepeatedMessageField(value: &_storage._step) }()
        case 7: try { try decoder.decodeSingularMessageField(value: &_storage._completionDisplay) }()
        case 8: try { try decoder.decodeSingularEnumField(value: &_storage._context) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._context != .pokestopIncident {
        try visitor.visitSingularEnumField(value: _storage._context, fieldNumber: 8)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension POGOProtos_Networking_Responses_StartIncidentResponse.ClientIncident.ClientIncidentStep: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .invasionBattle?: try {
      guard case .invasionBattle(let v)? = self.clientIncidentStep else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .invasionEncounter?: try {
      guard case .invasionEncounter(let v)? = self.clientIncidentStep else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .pokestopDialogue?: try {
      guard case .pokestopDialogue(let v)? = self.clientIncidentStep else { preconditionFailure() }
...
extension POGOProtos_Networking_Responses_StartIncidentResponse.ClientIncident.ClientIncidentStep.ClientInvasionBattleStep: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.character) }()
      default: break
      }
    }
  }
...
extension POGOProtos_Networking_Responses_StartIncidentResponse.ClientIncident.ClientIncidentStep.ClientPokestopNpcDialogueStep: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.dialogueLine) }()
      default: break
      }
    }
  }
...
extension POGOProtos_Networking_Responses_StartIncidentResponse.ClientIncident.ClientIncidentStep.ClientPokestopNpcDialogueStep.ClientDialogueLine: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularEnumField(value: &self.expression) }()
      default: break
      }
    }
  }
