...
extension POGOProtos_Networking_Responses_GetGymDetailsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeRepeatedStringField(value: &self.secondaryURL) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.checkinImageURL) }()
      case 8: try { try decoder.decodeSingularMessageField(value: &self._eventInfo) }()
      default: break
      }
    }
  }
