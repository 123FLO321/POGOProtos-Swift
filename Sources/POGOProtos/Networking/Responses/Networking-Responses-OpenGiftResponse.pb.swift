  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._eggPokemon) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._updatedFriendshipData) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._friendProfile) }()
        default: break
        }
      }
    }
