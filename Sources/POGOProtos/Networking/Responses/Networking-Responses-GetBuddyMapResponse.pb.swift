...
public struct POGOProtos_Networking_Responses_GetBuddyMapResponse {
  ...
  public var result: POGOProtos_Networking_Responses_GetBuddyMapResponse.Result = .unset
...
extension POGOProtos_Networking_Responses_GetBuddyMapResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularInt64Field(value: &self.expirationMs)
      case 3: try decoder.decodeSingularInt64Field(value: &self.appliedMs)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.expirationMs != 0 {
      try visitor.visitSingularInt64Field(value: self.expirationMs, fieldNumber: 2)
    }
    if self.appliedMs != 0 {
      try visitor.visitSingularInt64Field(value: self.appliedMs, fieldNumber: 3)
    }
