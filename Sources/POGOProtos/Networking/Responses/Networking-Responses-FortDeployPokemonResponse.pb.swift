...
extension POGOProtos_Networking_Responses_FortDeployPokemonResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._fortDetails) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._pokemonData) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._gymState) }()
      default: break
      }
    }
  }
