...
extension POGOProtos_Networking_Responses_CheckAwardedBadgesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedEnumField(value: &self.awardedBadges) }()
      case 3: try { try decoder.decodeRepeatedInt32Field(value: &self.awardedBadgeLevels) }()
      case 4: try { try decoder.decodeRepeatedStringField(value: &self.avatarTemplateIds) }()
      default: break
      }
    }
  }
