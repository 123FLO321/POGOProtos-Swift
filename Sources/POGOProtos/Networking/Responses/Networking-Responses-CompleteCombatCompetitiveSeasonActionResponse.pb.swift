...
extension POGOProtos_Networking_Responses_CompleteCombatCompetitiveSeasonActionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._lootProto) }()
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._lastSeasonResult) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.wasPlayerActive) }()
      default: break
      }
    }
  }
