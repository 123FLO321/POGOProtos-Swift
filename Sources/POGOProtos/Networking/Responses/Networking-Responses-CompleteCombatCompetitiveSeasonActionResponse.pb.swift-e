...
public struct POGOProtos_Networking_Responses_CompleteCombatCompetitiveSeasonActionResponse {
  ...
  public var lastSeasonResult: POGOProtos_Data_Combat_CombatSeasonResult {
    get {return _storage._lastSeasonResult ?? POGOProtos_Data_Combat_CombatSeasonResult()}
    set {_uniqueStorage()._lastSeasonResult = newValue}
  }
  /// Returns true if `lastSeasonResult` has been explicitly set.
  public var hasLastSeasonResult: Bool {return _storage._lastSeasonResult != nil}
  /// Clears the value of `lastSeasonResult`. Subsequent reads from it will return its default value.
  public mutating func clearLastSeasonResult() {_uniqueStorage()._lastSeasonResult = nil}

  public var wasPlayerActive: Bool {
    get {return _storage._wasPlayerActive}
    set {_uniqueStorage()._wasPlayerActive = newValue}
  }
...
extension POGOProtos_Networking_Responses_CompleteCombatCompetitiveSeasonActionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _lastSeasonResult: POGOProtos_Data_Combat_CombatSeasonResult? = nil
    var _wasPlayerActive: Bool = false
    ...
    init(copying source: _StorageClass) {
      ...
      _lastSeasonResult = source._lastSeasonResult
      _wasPlayerActive = source._wasPlayerActive
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 5: try decoder.decodeSingularMessageField(value: &_storage._lastSeasonResult)
        case 6: try decoder.decodeSingularBoolField(value: &_storage._wasPlayerActive)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._lastSeasonResult {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      }
      if _storage._wasPlayerActive != false {
        try visitor.visitSingularBoolField(value: _storage._wasPlayerActive, fieldNumber: 6)
      }
    }
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_CompleteCombatCompetitiveSeasonActionResponse, rhs: POGOProtos_Networking_Responses_CompleteCombatCompetitiveSeasonActionResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._lastSeasonResult != rhs_storage._lastSeasonResult {return false}
        if _storage._wasPlayerActive != rhs_storage._wasPlayerActive {return false}
        return true
      }
