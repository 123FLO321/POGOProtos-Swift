...
public struct POGOProtos_Networking_Responses_DownloadSettingsActionResponse {
...
extension POGOProtos_Networking_Responses_DownloadSettingsActionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DownloadSettingsActionResponse"
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_DownloadSettingsActionResponse, rhs: POGOProtos_Networking_Responses_DownloadSettingsActionResponse) -> Bool {
