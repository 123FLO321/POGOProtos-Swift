  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularEnumField(value: &_storage._teamColor) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._pokemonData) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._name) }()
        case 5: try { try decoder.decodeRepeatedStringField(value: &_storage._imageUrls) }()
        case 6: try { try decoder.decodeSingularInt32Field(value: &_storage._fp) }()
        case 7: try { try decoder.decodeSingularInt32Field(value: &_storage._stamina) }()
        case 8: try { try decoder.decodeSingularInt32Field(value: &_storage._maxStamina) }()
        case 9: try { try decoder.decodeSingularEnumField(value: &_storage._type) }()
        case 10: try { try decoder.decodeSingularDoubleField(value: &_storage._latitude) }()
        case 11: try { try decoder.decodeSingularDoubleField(value: &_storage._longitude) }()
        case 12: try { try decoder.decodeSingularStringField(value: &_storage._description_p) }()
        case 13: try { try decoder.decodeRepeatedMessageField(value: &_storage._modifiers) }()
        case 14: try { try decoder.decodeSingularBoolField(value: &_storage._closeSoon) }()
        case 15: try { try decoder.decodeSingularStringField(value: &_storage._checkinImageURL) }()
        case 16: try { try decoder.decodeSingularMessageField(value: &_storage._eventInfo) }()
        case 17: try { try decoder.decodeRepeatedStringField(value: &_storage._promoDescription) }()
        case 18: try { try decoder.decodeSingularStringField(value: &_storage._callToActionLink) }()
        case 19: try { try decoder.decodeSingularMessageField(value: &_storage._sponsoredDetails) }()
        case 20: try { try decoder.decodeSingularStringField(value: &_storage._geostoreTombstoneMessageKey) }()
        case 21: try { try decoder.decodeSingularStringField(value: &_storage._geostoreSuspensionMessageKey) }()
        case 22: try { try decoder.decodeSingularInt32Field(value: &_storage._poiImagesCount) }()
        default: break
        }
      }
    }
