...
extension POGOProtos_Networking_Responses_GetVsSeekerStatusResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._vsSeeker) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.seasonEnded) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._combatLog) }()
      default: break
      }
    }
  }
