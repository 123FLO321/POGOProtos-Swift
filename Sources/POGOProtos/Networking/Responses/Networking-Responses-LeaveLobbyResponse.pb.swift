...
public struct POGOProtos_Networking_Responses_LeaveLobbyResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Responses_LeaveLobbyResponse.Result {
  ...
  public enum Result: SwiftProtobuf.Enum {
    ...
    public init?(rawValue: Int) {
      ...
      case 0: self = .unset
      case 1: self = .success
      case 2: self = .errorRaidUnavailable
    ...
    public var rawValue: Int {
      ...
      case .errorRaidUnavailable: return 2
...
extension POGOProtos_Networking_Responses_LeaveLobbyResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Responses_LeaveLobbyResponse.Result] = [
    .unset,
    .success,
...
extension POGOProtos_Networking_Responses_LeaveLobbyResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _result: POGOProtos_Networking_Responses_LeaveLobbyResponse.Result = .unset
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_LeaveLobbyResponse, rhs: POGOProtos_Networking_Responses_LeaveLobbyResponse) -> Bool {
...
extension POGOProtos_Networking_Responses_LeaveLobbyResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
    1: .same(proto: "SUCCESS"),
    2: .same(proto: "ERROR_RAID_UNAVAILABLE"),
