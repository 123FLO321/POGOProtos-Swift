...
public struct POGOProtos_Networking_Responses_BelugaTransactionStartResponse {
  ...
  public var status: POGOProtos_Networking_Responses_BelugaTransactionStartResponse.Status {
    get {return _storage._status}
    set {_uniqueStorage()._status = newValue}
  }

  public var belugaTransferPrep: POGOProtos_Data_Beluga_BelugaBleTransferPrep {
    get {return _storage._belugaTransferPrep ?? POGOProtos_Data_Beluga_BelugaBleTransferPrep()}
    set {_uniqueStorage()._belugaTransferPrep = newValue}
  }
  /// Returns true if `belugaTransferPrep` has been explicitly set.
  public var hasBelugaTransferPrep: Bool {return _storage._belugaTransferPrep != nil}
  /// Clears the value of `belugaTransferPrep`. Subsequent reads from it will return its default value.
  public mutating func clearBelugaTransferPrep() {_uniqueStorage()._belugaTransferPrep = nil}
...
extension POGOProtos_Networking_Responses_BelugaTransactionStartResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _status: POGOProtos_Networking_Responses_BelugaTransactionStartResponse.Status = .unset
    var _belugaTransferPrep: POGOProtos_Data_Beluga_BelugaBleTransferPrep? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _belugaTransferPrep = source._belugaTransferPrep
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularMessageField(value: &_storage._belugaTransferPrep)
        case 3: try decoder.decodeSingularBytesField(value: &_storage._serverSignature)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._belugaTransferPrep {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      }
      if !_storage._serverSignature.isEmpty {
        try visitor.visitSingularBytesField(value: _storage._serverSignature, fieldNumber: 3)
      }
    }
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_BelugaTransactionStartResponse, rhs: POGOProtos_Networking_Responses_BelugaTransactionStartResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._belugaTransferPrep != rhs_storage._belugaTransferPrep {return false}
