...
extension POGOProtos_Networking_Responses_GetAssetDigestResponse.Result: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Networking_Responses_GetAssetDigestResponse.Result] = [
    .unset,
    .success,
    .page,
    .retry,
...
extension POGOProtos_Networking_Responses_GetAssetDigestResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.digest) }()
...
extension POGOProtos_Networking_Responses_GetAssetDigestResponse.AssetDigestEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularFixed32Field(value: &self.checksum) }()
