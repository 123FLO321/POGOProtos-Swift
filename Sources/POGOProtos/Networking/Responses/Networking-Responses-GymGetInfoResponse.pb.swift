...
public struct POGOProtos_Networking_Responses_GymGetInfoResponse {
  ...
  public var result: POGOProtos_Networking_Responses_GymGetInfoResponse.Result {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularMessageField(value: &_storage._gymStatusAndDefenders) }()
        ...
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._secondaryURL) }()
        case 7: try { try decoder.decodeSingularMessageField(value: &_storage._awardedGymBadge) }()
        case 8: try { try decoder.decodeSingularStringField(value: &_storage._checkinImageURL) }()
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._eventInfo) }()
        case 10: try { try decoder.decodeSingularMessageField(value: &_storage._displayWeather) }()
        case 11: try { try decoder.decodeRepeatedStringField(value: &_storage._promoImage) }()
        case 12: try { try decoder.decodeRepeatedStringField(value: &_storage._promoDescription) }()
        case 13: try { try decoder.decodeSingularStringField(value: &_storage._callToActionLink) }()
        case 14: try { try decoder.decodeSingularInt64Field(value: &_storage._serverMs) }()
        case 15: try { try decoder.decodeSingularMessageField(value: &_storage._sponsoredDetails) }()
        default: break
        }
      }
    }
