...
extension POGOProtos_Networking_Responses_GetTradingResponse.Result: CaseIterable {
  ...
  static var allCases: [POGOProtos_Networking_Responses_GetTradingResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
    .errorFriendNotFound,
...
extension POGOProtos_Networking_Responses_GetTradingResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    public var _result: POGOProtos_Networking_Responses_GetTradingResponse.Result = .unset
