...
extension POGOProtos_Networking_Responses_GetBuddyWalkedResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularEnumField(value: &self.familyCandyID) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.candyEarnedCount) }()
      case 4: try { try decoder.decodeSingularDoubleField(value: &self.kmRemaining) }()
      case 5: try { try decoder.decodeSingularDoubleField(value: &self.lastKmAwarded) }()
      case 6: try { try decoder.decodeSingularInt32Field(value: &self.megaEnergyEarnedCount) }()
