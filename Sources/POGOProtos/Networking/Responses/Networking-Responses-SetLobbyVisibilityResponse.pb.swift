...
public struct POGOProtos_Networking_Responses_SetLobbyVisibilityResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Responses_SetLobbyVisibilityResponse.Result = .unset
...
extension POGOProtos_Networking_Responses_SetLobbyVisibilityResponse.Result: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Networking_Responses_SetLobbyVisibilityResponse.Result] = [
    .unset,
    .success,
...
extension POGOProtos_Networking_Responses_SetLobbyVisibilityResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SetLobbyVisibilityResponse"
  ...
  public static func ==(lhs: POGOProtos_Networking_Responses_SetLobbyVisibilityResponse, rhs: POGOProtos_Networking_Responses_SetLobbyVisibilityResponse) -> Bool {
