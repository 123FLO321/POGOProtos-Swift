...
extension POGOProtos_Networking_Responses_UseItemRareCandyResponse.Result: CaseIterable {
  ...
  static var allCases: [POGOProtos_Networking_Responses_UseItemRareCandyResponse.Result] = [
    .unset,
    .success,
    .invalidPokemonID,
    .noPlayer,
...
extension POGOProtos_Networking_Responses_UseItemRareCandyResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularInt32Field(value: &self.updatedCandyCount)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.updatedCandyCount != 0 {
      try visitor.visitSingularInt32Field(value: self.updatedCandyCount, fieldNumber: 3)
    }
