...
// Source: POGOProtos/Networking/Titan/Responses/SubmitNewRouteResponse.proto
//
...
public struct POGOProtos_Networking_Titan_Responses_SubmitNewRouteResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var status: POGOProtos_Networking_Titan_Responses_SubmitNewRouteResponse.Status = .unspecified
...
extension POGOProtos_Networking_Titan_Responses_SubmitNewRouteResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Titan_Responses_SubmitNewRouteResponse.Status] = [
    .unspecified,
    .success,
    .internalError,
...
extension POGOProtos_Networking_Titan_Responses_SubmitNewRouteResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Titan_Responses_SubmitNewRouteResponse, rhs: POGOProtos_Networking_Titan_Responses_SubmitNewRouteResponse) -> Bool {
...
extension POGOProtos_Networking_Titan_Responses_SubmitNewRouteResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
