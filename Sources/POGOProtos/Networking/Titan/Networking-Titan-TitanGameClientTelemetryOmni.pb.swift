...
// Source: POGOProtos/Networking/Titan/TitanGameClientTelemetryOmni.proto
//
...
public struct POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var telemetryData: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.OneOf_TelemetryData? = nil

  public var poiSubmissionTelemetry: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry {
    get {
      if case .poiSubmissionTelemetry(let v)? = telemetryData {return v}
      return POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry()
    }
    set {telemetryData = .poiSubmissionTelemetry(newValue)}
  }

  public var poiSubmissionPhotoUploadErrorTelemetry: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry {
    get {
      if case .poiSubmissionPhotoUploadErrorTelemetry(let v)? = telemetryData {return v}
      return POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry()
    }
    set {telemetryData = .poiSubmissionPhotoUploadErrorTelemetry(newValue)}
  }

  public var playerMetadataTelemetry: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiPlayerMetadataTelemetry {
    get {
      if case .playerMetadataTelemetry(let v)? = telemetryData {return v}
      return POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiPlayerMetadataTelemetry()
    }
  ...
  public enum OneOf_TelemetryData: Equatable {
    case poiSubmissionTelemetry(POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry)
    case poiSubmissionPhotoUploadErrorTelemetry(POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry)
    case playerMetadataTelemetry(POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiPlayerMetadataTelemetry)
    case serverData(POGOProtos_Data_Telemetry_PlatformServerData)

  #if !swift(>=4.1)
    public static func ==(lhs: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.OneOf_TelemetryData, rhs: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.OneOf_TelemetryData) -> Bool {
      switch (lhs, rhs) {
  ...
  public struct PoiSubmissionPhotoUploadErrorTelemetry {
    ...
    public var errorID: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry.PoiSubmissionPhotoUploadErrorIds = .unset
  ...
  public struct PoiSubmissionTelemetry {
    ...
    public var guiEventID: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry.PoiSubmissionGuiEventId = .unknown

    public var imageType: POGOProtos_Enums_PoiImageType = .unset

    public var cameraStepID: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry.PoiCameraStepIds = .unset
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry.PoiSubmissionPhotoUploadErrorIds: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry.PoiSubmissionPhotoUploadErrorIds] = [
    .unset,
    .poiPhotoUploadError,
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry.PoiCameraStepIds: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry.PoiCameraStepIds] = [
    .unset,
    .enter,
    .retake,
    .confirm,
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry.PoiSubmissionGuiEventId: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry.PoiSubmissionGuiEventId] = [
    .unknown,
    .poiNominationEnter,
    .poiTutorialComplete,
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1:
        var v: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry?
      ...
      case 2:
        var v: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry?
        if let current = self.telemetryData {
          try decoder.handleConflictingOneOf()
      ...
      case 3:
        var v: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiPlayerMetadataTelemetry?
        if let current = self.telemetryData {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni, rhs: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni) -> Bool {
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiPlayerMetadataTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.protoMessageName + ".PoiPlayerMetadataTelemetry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.protoMessageName + ".PoiSubmissionPhotoUploadErrorTelemetry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry, rhs: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry) -> Bool {
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionPhotoUploadErrorTelemetry.PoiSubmissionPhotoUploadErrorIds: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.protoMessageName + ".PoiSubmissionTelemetry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry, rhs: POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry) -> Bool {
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry.PoiCameraStepIds: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
    1: .same(proto: "ENTER"),
    2: .same(proto: "RETAKE"),
...
extension POGOProtos_Networking_Titan_TitanGameClientTelemetryOmni.PoiSubmissionTelemetry.PoiSubmissionGuiEventId: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
