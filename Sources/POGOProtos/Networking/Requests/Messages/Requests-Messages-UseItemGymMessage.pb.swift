...
public struct POGOProtos_Networking_Requests_Messages_UseItemGymMessage {
...
extension POGOProtos_Networking_Requests_Messages_UseItemGymMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UseItemGymMessage"
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_UseItemGymMessage, rhs: POGOProtos_Networking_Requests_Messages_UseItemGymMessage) -> Bool {
