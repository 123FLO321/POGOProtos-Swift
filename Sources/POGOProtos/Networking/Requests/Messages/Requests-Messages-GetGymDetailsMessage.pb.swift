...
extension POGOProtos_Networking_Requests_Messages_GetGymDetailsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularDoubleField(value: &self.playerLatitude) }()
      case 3: try { try decoder.decodeSingularDoubleField(value: &self.playerLongitude) }()
      case 4: try { try decoder.decodeSingularDoubleField(value: &self.gymLatitude) }()
      case 5: try { try decoder.decodeSingularDoubleField(value: &self.gymLongitude) }()
