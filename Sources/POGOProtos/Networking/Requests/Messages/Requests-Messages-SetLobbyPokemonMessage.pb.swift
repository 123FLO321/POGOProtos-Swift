...
public struct POGOProtos_Networking_Requests_Messages_SetLobbyPokemonMessage {
...
extension POGOProtos_Networking_Requests_Messages_SetLobbyPokemonMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SetLobbyPokemonMessage"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeRepeatedFixed64Field(value: &self.pokemonID) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.pokemonID.isEmpty {
      try visitor.visitPackedFixed64Field(value: self.pokemonID, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_SetLobbyPokemonMessage, rhs: POGOProtos_Networking_Requests_Messages_SetLobbyPokemonMessage) -> Bool {
