...
public struct POGOProtos_Networking_Requests_Messages_EncounterMessage {
...
extension POGOProtos_Networking_Requests_Messages_EncounterMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".EncounterMessage"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.spawnPointID) }()
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_EncounterMessage, rhs: POGOProtos_Networking_Requests_Messages_EncounterMessage) -> Bool {
