...
public struct POGOProtos_Networking_Requests_Messages_SubmitCombatChallengePokemonsMessage {
...
extension POGOProtos_Networking_Requests_Messages_SubmitCombatChallengePokemonsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SubmitCombatChallengePokemonsMessage"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.lobbyJoinTimeMs) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_SubmitCombatChallengePokemonsMessage, rhs: POGOProtos_Networking_Requests_Messages_SubmitCombatChallengePokemonsMessage) -> Bool {
