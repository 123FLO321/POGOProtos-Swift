...
extension POGOProtos_Networking_Requests_Messages_SfidaCaptureMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.spawnpointID) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.encounterID) }()
      case 3: try { try decoder.decodeSingularDoubleField(value: &self.playerLat) }()
      case 4: try { try decoder.decodeSingularDoubleField(value: &self.playerLng) }()
      case 5: try { try decoder.decodeSingularEnumField(value: &self.encounterType) }()
      case 6: try { try decoder.decodeSingularDoubleField(value: &self.gymLat) }()
      case 7: try { try decoder.decodeSingularDoubleField(value: &self.gymLng) }()
      default: break
      }
    }
  }
