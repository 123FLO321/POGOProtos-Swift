...
// Source: POGOProtos/Networking/Requests/Messages/LocationPingMessage.proto
//
...
public struct POGOProtos_Networking_Requests_Messages_LocationPingMessage {
  ...
  public var reason: POGOProtos_Networking_Requests_Messages_LocationPingMessage.PingReason = .unset
...
extension POGOProtos_Networking_Requests_Messages_LocationPingMessage.PingReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Requests_Messages_LocationPingMessage.PingReason] = [
    .unset,
    .entranceEvent,
    .exitEvent,
    .dwellEvent,
...
extension POGOProtos_Networking_Requests_Messages_LocationPingMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".LocationPingMessage"
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_LocationPingMessage, rhs: POGOProtos_Networking_Requests_Messages_LocationPingMessage) -> Bool {
...
extension POGOProtos_Networking_Requests_Messages_LocationPingMessage.PingReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
