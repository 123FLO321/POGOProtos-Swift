...
public struct POGOProtos_Networking_Requests_Messages_CheckShareExRaidPassMessage {
...
extension POGOProtos_Networking_Requests_Messages_CheckShareExRaidPassMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CheckShareExRaidPassMessage"
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_CheckShareExRaidPassMessage, rhs: POGOProtos_Networking_Requests_Messages_CheckShareExRaidPassMessage) -> Bool {
