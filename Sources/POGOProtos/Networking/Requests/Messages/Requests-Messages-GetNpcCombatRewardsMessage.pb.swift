...
extension POGOProtos_Networking_Requests_Messages_GetNpcCombatRewardsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.combatNpcTrainerTemplateID) }()
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self.combatID) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._combatQuestUpdate) }()
      default: break
      }
    }
  }
