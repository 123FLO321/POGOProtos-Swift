...
public struct POGOProtos_Networking_Requests_Messages_GetDownloadUrlsMessage {
...
extension POGOProtos_Networking_Requests_Messages_GetDownloadUrlsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetDownloadUrlsMessage"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedStringField(value: &self.assetID) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_GetDownloadUrlsMessage, rhs: POGOProtos_Networking_Requests_Messages_GetDownloadUrlsMessage) -> Bool {
