...
public struct POGOProtos_Networking_Requests_Messages_OpenCombatSessionMessage {
...
extension POGOProtos_Networking_Requests_Messages_OpenCombatSessionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".OpenCombatSessionMessage"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.combatID) }()
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_OpenCombatSessionMessage, rhs: POGOProtos_Networking_Requests_Messages_OpenCombatSessionMessage) -> Bool {
