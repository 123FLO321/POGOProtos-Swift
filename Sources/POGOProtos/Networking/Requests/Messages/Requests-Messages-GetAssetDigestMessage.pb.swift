...
extension POGOProtos_Networking_Requests_Messages_GetAssetDigestMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularBoolField(value: &self.paginate) }()
      case 7: try { try decoder.decodeSingularInt32Field(value: &self.pageOffset) }()
      case 8: try { try decoder.decodeSingularUInt64Field(value: &self.pageTimestamp) }()
      default: break
      }
    }
  }
