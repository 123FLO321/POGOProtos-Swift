...
extension POGOProtos_Networking_Requests_Messages_MarkTutorialCompleteMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedEnumField(value: &self.tutorialsCompleted) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.sendMarketingEmails) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.sendPushNotifications) }()
      default: break
      }
    }
  }
