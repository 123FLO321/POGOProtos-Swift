...
extension POGOProtos_Networking_Requests_Messages_GetRaidDetailsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularDoubleField(value: &self.gymLatDegrees) }()
      case 7: try { try decoder.decodeSingularDoubleField(value: &self.gymLngDegrees) }()
      case 8: try { try decoder.decodeSingularStringField(value: &self.inviterID) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.inviterID.isEmpty {
      try visitor.visitSingularStringField(value: self.inviterID, fieldNumber: 8)
    }
