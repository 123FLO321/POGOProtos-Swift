...
extension POGOProtos_Networking_Requests_Messages_StartGymBattleMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedFixed64Field(value: &self.attackingPokemonIds)
      case 3: try decoder.decodeSingularFixed64Field(value: &self.defendingPokemonID)
      case 4: try decoder.decodeSingularDoubleField(value: &self.playerLatitude)
      case 5: try decoder.decodeSingularDoubleField(value: &self.playerLongitude)
      default: break
      }
    }
  }
