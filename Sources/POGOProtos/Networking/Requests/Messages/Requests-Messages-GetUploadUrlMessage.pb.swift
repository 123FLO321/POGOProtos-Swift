...
public struct POGOProtos_Networking_Requests_Messages_GetUploadUrlMessage {
...
extension POGOProtos_Networking_Requests_Messages_GetUploadUrlMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.gameUniqueID) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self.submissionType) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.submissionID) }()
      case 5: try { try decoder.decodeRepeatedStringField(value: &self.imageContexts) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_GetUploadUrlMessage, rhs: POGOProtos_Networking_Requests_Messages_GetUploadUrlMessage) -> Bool {
