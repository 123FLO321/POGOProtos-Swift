...
extension POGOProtos_Networking_Requests_Messages_ListAvatarCustomizationsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.avatarType) }()
      case 2: try { try decoder.decodeRepeatedEnumField(value: &self.slot) }()
      case 3: try { try decoder.decodeRepeatedEnumField(value: &self.filters) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.start) }()
