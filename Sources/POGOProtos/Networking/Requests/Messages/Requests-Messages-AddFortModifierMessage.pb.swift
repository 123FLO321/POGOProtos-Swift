...
public struct POGOProtos_Networking_Requests_Messages_AddFortModifierMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var modifierType: POGOProtos_Inventory_Item_ItemId = .itemUnknown
...
extension POGOProtos_Networking_Requests_Messages_AddFortModifierMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AddFortModifierMessage"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.modifierType) }()
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_AddFortModifierMessage, rhs: POGOProtos_Networking_Requests_Messages_AddFortModifierMessage) -> Bool {
