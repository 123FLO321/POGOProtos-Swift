...
extension POGOProtos_Networking_Requests_Messages_EvolvePokemonMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularEnumField(value: &self.targetPokemonID) }()
      case 4: try { try decoder.decodeSingularEnumField(value: &self.targetPokemonForm) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.useSpecial) }()
      default: break
      }
    }
  }
