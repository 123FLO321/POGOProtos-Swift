...
public struct POGOProtos_Networking_Requests_Messages_FortDeployPokemonMessage {
...
extension POGOProtos_Networking_Requests_Messages_FortDeployPokemonMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FortDeployPokemonMessage"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularFixed64Field(value: &self.pokemonID) }()
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_FortDeployPokemonMessage, rhs: POGOProtos_Networking_Requests_Messages_FortDeployPokemonMessage) -> Bool {
