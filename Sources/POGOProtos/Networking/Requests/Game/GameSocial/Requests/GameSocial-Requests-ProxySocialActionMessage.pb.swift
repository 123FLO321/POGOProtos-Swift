...
public struct POGOProtos_Networking_Requests_Game_GameSocial_Requests_ProxySocialActionMessage {
...
extension POGOProtos_Networking_Requests_Game_GameSocial_Requests_ProxySocialActionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Game_GameSocial_Requests_ProxySocialActionMessage, rhs: POGOProtos_Networking_Requests_Game_GameSocial_Requests_ProxySocialActionMessage) -> Bool {
