...
public struct POGOProtos_Networking_Requests_Game_GamePoi_Requests_SubmitPoiImageMessage {
...
extension POGOProtos_Networking_Requests_Game_GamePoi_Requests_SubmitPoiImageMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBoolField(value: &self.asyncFileUpload) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Game_GamePoi_Requests_SubmitPoiImageMessage, rhs: POGOProtos_Networking_Requests_Game_GamePoi_Requests_SubmitPoiImageMessage) -> Bool {
