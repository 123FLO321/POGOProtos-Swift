...
public struct POGOProtos_Networking_Requests_Game_GamePoi_Requests_SubmitPoiLocationUpdateMessage {
...
extension POGOProtos_Networking_Requests_Game_GamePoi_Requests_SubmitPoiLocationUpdateMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Game_GamePoi_Requests_SubmitPoiLocationUpdateMessage, rhs: POGOProtos_Networking_Requests_Game_GamePoi_Requests_SubmitPoiLocationUpdateMessage) -> Bool {
