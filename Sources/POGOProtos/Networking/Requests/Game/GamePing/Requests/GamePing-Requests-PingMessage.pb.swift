...
extension POGOProtos_Networking_Requests_Game_GamePing_Requests_PingMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.responseSizeBytes) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.randomRequestBytes) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.useCacheForRandomRequestBytes) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.returnValue) }()
      default: break
      }
    }
  }
