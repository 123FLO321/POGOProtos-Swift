...
public struct POGOProtos_Networking_Requests_Game_GameAccountRegistry_Requests_AddLoginActionMessage {
  ...
  public var innerMessage: Data = Data()
...
extension POGOProtos_Networking_Requests_Game_GameAccountRegistry_Requests_AddLoginActionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.identityProvider) }()
      case 2: try { try decoder.decodeSingularBytesField(value: &self.innerMessage) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.authProviderID) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Game_GameAccountRegistry_Requests_AddLoginActionMessage, rhs: POGOProtos_Networking_Requests_Game_GameAccountRegistry_Requests_AddLoginActionMessage) -> Bool {
