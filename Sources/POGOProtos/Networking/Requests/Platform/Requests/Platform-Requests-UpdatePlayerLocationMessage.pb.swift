...
public struct POGOProtos_Networking_Requests_Platform_Requests_UpdatePlayerLocationMessage {
  ...
  public var reason: POGOProtos_Networking_Requests_Platform_Requests_UpdatePlayerLocationMessage.PingReason = .unset
...
extension POGOProtos_Networking_Requests_Platform_Requests_UpdatePlayerLocationMessage.PingReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Requests_Platform_Requests_UpdatePlayerLocationMessage.PingReason] = [
    .unset,
    .entranceEvent,
    .exitEvent,
    .dwellEvent,
...
extension POGOProtos_Networking_Requests_Platform_Requests_UpdatePlayerLocationMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Platform_Requests_UpdatePlayerLocationMessage, rhs: POGOProtos_Networking_Requests_Platform_Requests_UpdatePlayerLocationMessage) -> Bool {
...
extension POGOProtos_Networking_Requests_Platform_Requests_UpdatePlayerLocationMessage.PingReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
