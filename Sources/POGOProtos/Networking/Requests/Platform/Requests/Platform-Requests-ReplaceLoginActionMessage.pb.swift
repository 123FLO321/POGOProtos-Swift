...
public struct POGOProtos_Networking_Requests_Platform_Requests_ReplaceLoginActionMessage {
...
extension POGOProtos_Networking_Requests_Platform_Requests_ReplaceLoginActionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.existingIdentityProvider) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._newLogin) }()
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Platform_Requests_ReplaceLoginActionMessage, rhs: POGOProtos_Networking_Requests_Platform_Requests_ReplaceLoginActionMessage) -> Bool {
