...
public struct POGOProtos_Networking_Requests_Platform_Requests_RedeemAppleReceiptMessage {
...
extension POGOProtos_Networking_Requests_Platform_Requests_RedeemAppleReceiptMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.purchaseCurrency) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.pricePaidE6) }()
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Platform_Requests_RedeemAppleReceiptMessage, rhs: POGOProtos_Networking_Requests_Platform_Requests_RedeemAppleReceiptMessage) -> Bool {
