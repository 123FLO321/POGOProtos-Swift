...
public struct POGOProtos_Networking_Requests_Platform_Requests_SubmitPoiTakedownRequestMessage {
  ...
  public var invalidReason: POGOProtos_Networking_Requests_Platform_Requests_SubmitPoiTakedownRequestMessage.PoiInvalidReason = .invalidReasonUnspecified
...
extension POGOProtos_Networking_Requests_Platform_Requests_SubmitPoiTakedownRequestMessage.PoiInvalidReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Requests_Platform_Requests_SubmitPoiTakedownRequestMessage.PoiInvalidReason] = [
...
extension POGOProtos_Networking_Requests_Platform_Requests_SubmitPoiTakedownRequestMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Platform_Requests_SubmitPoiTakedownRequestMessage, rhs: POGOProtos_Networking_Requests_Platform_Requests_SubmitPoiTakedownRequestMessage) -> Bool {
...
extension POGOProtos_Networking_Requests_Platform_Requests_SubmitPoiTakedownRequestMessage.PoiInvalidReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
