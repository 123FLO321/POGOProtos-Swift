...
public enum POGOProtos_Networking_Requests_Social_SocialAction: SwiftProtobuf.Enum {
...
extension POGOProtos_Networking_Requests_Social_SocialAction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Requests_Social_SocialAction] = [
    .unknownSocialAction,
    .searchPlayer,
    .sendFriendInvite,
    .cancelFriendInvite,
...
extension POGOProtos_Networking_Requests_Social_SocialAction: SwiftProtobuf._ProtoNameProviding {
