...
public struct POGOProtos_Networking_Requests_Messages_Social_UpdateNotificationMessage {
...
fileprivate let _protobuf_package = "POGOProtos.Networking.Requests.Messages.Social"

extension POGOProtos_Networking_Requests_Messages_Social_UpdateNotificationMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Requests_Messages_Social_UpdateNotificationMessage, rhs: POGOProtos_Networking_Requests_Messages_Social_UpdateNotificationMessage) -> Bool {
