...
extension POGOProtos_Networking_Requests_Titan_Requests_SubmitNewPoiMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 14: try { try decoder.decodeSingularStringField(value: &self.supportingStatement) }()
      case 18: try { try decoder.decodeSingularBoolField(value: &self.asyncFileUpload) }()
      default: break
      }
    }
  }
