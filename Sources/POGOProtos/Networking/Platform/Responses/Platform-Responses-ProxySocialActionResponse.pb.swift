...
// Source: POGOProtos/Networking/Platform/Responses/ProxySocialActionResponse.proto
//
...
public struct POGOProtos_Networking_Platform_Responses_ProxySocialActionResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var status: POGOProtos_Networking_Platform_Responses_ProxySocialActionResponse.Status = .unset
...
extension POGOProtos_Networking_Platform_Responses_ProxySocialActionResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Platform_Responses_ProxySocialActionResponse.Status] = [
    .unset,
    .completed,
...
extension POGOProtos_Networking_Platform_Responses_ProxySocialActionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Platform_Responses_ProxySocialActionResponse, rhs: POGOProtos_Networking_Platform_Responses_ProxySocialActionResponse) -> Bool {
...
extension POGOProtos_Networking_Platform_Responses_ProxySocialActionResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
