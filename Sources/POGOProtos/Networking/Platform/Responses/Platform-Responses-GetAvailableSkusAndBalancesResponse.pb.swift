...
extension POGOProtos_Networking_Platform_Responses_GetAvailableSkusAndBalancesResponse.AvailableSku: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _gameItemContent: [POGOProtos_Networking_Platform_Responses_GetAvailableSkusAndBalancesResponse.GameItemContent] = []
    var _presentationData: [POGOProtos_Networking_Platform_Responses_GetAvailableSkusAndBalancesResponse.SkuPresentation] = []
