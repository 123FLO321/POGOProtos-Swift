...
public struct POGOProtos_Networking_Platform_Responses_RedeemGoogleReceiptResponse {
...
extension POGOProtos_Networking_Platform_Responses_RedeemGoogleReceiptResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Platform_Responses_RedeemGoogleReceiptResponse.Status] = [
    .unset,
    .success,
    .failure,
  ]
...
extension POGOProtos_Networking_Platform_Responses_RedeemGoogleReceiptResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension POGOProtos_Networking_Platform_Responses_RedeemGoogleReceiptResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
