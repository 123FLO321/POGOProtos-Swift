...
public struct POGOProtos_Networking_Platform_Responses_ReplaceLoginActionResponse {
  ...
  public var status: POGOProtos_Networking_Platform_Responses_ReplaceLoginActionResponse.Status = .unset
...
extension POGOProtos_Networking_Platform_Responses_ReplaceLoginActionResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Platform_Responses_ReplaceLoginActionResponse.Status] = [
    .unset,
    .authFailure,
    .loginTaken,
    .loginAlreadyHave,
...
extension POGOProtos_Networking_Platform_Responses_ReplaceLoginActionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Platform_Responses_ReplaceLoginActionResponse, rhs: POGOProtos_Networking_Platform_Responses_ReplaceLoginActionResponse) -> Bool {
...
extension POGOProtos_Networking_Platform_Responses_ReplaceLoginActionResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
