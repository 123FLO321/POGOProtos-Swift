...
public struct POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse {
  ...
  ///unconfirmed
  public var status: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.Status = .undefined

  /// Items to show in the shop
  public var items: [POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreItem] = []

  /// currencies that player has at the moment
  public var playerCurrencies: [POGOProtos_Data_Player_Currency] = []
  ...
  public struct StoreItem {
    ...
    public var currencyToBuy: POGOProtos_Data_Player_Currency {
    ...
    public var hasCurrencyToBuy: Bool {return _storage._currencyToBuy != nil}
    /// Clears the value of `currencyToBuy`. Subsequent reads from it will return its default value.
    public mutating func clearCurrencyToBuy() {_uniqueStorage()._currencyToBuy = nil}

    /// When bought, this IAP will yield this much currency
    public var yieldsCurrency: POGOProtos_Data_Player_Currency {
    ...
    public var hasYieldsCurrency: Bool {return _storage._yieldsCurrency != nil}
    /// Clears the value of `yieldsCurrency`. Subsequent reads from it will return its default value.
    public mutating func clearYieldsCurrency() {_uniqueStorage()._yieldsCurrency = nil}

    /// The item and count of such item that this IAP will yield
    public var yieldsItem: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreItemInfo {
    ...
    public var hasYieldsItem: Bool {return _storage._yieldsItem != nil}
    /// Clears the value of `yieldsItem`. Subsequent reads from it will return its default value.
    public mutating func clearYieldsItem() {_uniqueStorage()._yieldsItem = nil}

    /// Stuff like SORT:12, CATEGORY:ITEMS
    public var tags: [POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreTags] {
...
extension POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetStoreItemsResponse"
  ...
  public static func ==(lhs: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse, rhs: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse) -> Bool {
...
extension POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.protoMessageName + ".StoreItem"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreItem, rhs: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreItem) -> Bool {
...
extension POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreTags: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.protoMessageName + ".StoreTags"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "tag"),
    2: .same(proto: "value"),
  ]
  ...
  public static func ==(lhs: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreTags, rhs: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreTags) -> Bool {
...
extension POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreItemInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.protoMessageName + ".StoreItemInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "item_id"),
    2: .same(proto: "count"),
  ]
  ...
  public static func ==(lhs: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreItemInfo, rhs: POGOProtos_Networking_Platform_Responses_GetStoreItemsResponse.StoreItemInfo) -> Bool {
