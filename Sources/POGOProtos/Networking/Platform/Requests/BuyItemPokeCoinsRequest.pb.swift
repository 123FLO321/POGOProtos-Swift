...
public struct POGOProtos_Networking_Platform_Requests_BuyItemPokeCoinsRequest {
...
extension POGOProtos_Networking_Platform_Requests_BuyItemPokeCoinsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".BuyItemPokeCoinsRequest"
  ...
  public static func ==(lhs: POGOProtos_Networking_Platform_Requests_BuyItemPokeCoinsRequest, rhs: POGOProtos_Networking_Platform_Requests_BuyItemPokeCoinsRequest) -> Bool {
