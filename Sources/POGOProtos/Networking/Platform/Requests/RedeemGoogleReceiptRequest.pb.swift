...
public struct POGOProtos_Networking_Platform_Requests_RedeemGoogleReceiptRequest {
...
extension POGOProtos_Networking_Platform_Requests_RedeemGoogleReceiptRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RedeemGoogleReceiptRequest"
  ...
  public static func ==(lhs: POGOProtos_Networking_Platform_Requests_RedeemGoogleReceiptRequest, rhs: POGOProtos_Networking_Platform_Requests_RedeemGoogleReceiptRequest) -> Bool {
