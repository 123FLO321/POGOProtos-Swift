...
public struct POGOProtos_Networking_Envelopes_AuthTicket {
  ...
  public var start: Data = Data()

  public var expireTimestampMs: UInt64 = 0

  public var end: Data = Data()
...
extension POGOProtos_Networking_Envelopes_AuthTicket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBytesField(value: &self.start) }()
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.expireTimestampMs) }()
      case 3: try { try decoder.decodeSingularBytesField(value: &self.end) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.expireTimestampMs != 0 {
      try visitor.visitSingularUInt64Field(value: self.expireTimestampMs, fieldNumber: 2)
    }
    if !self.end.isEmpty {
      try visitor.visitSingularBytesField(value: self.end, fieldNumber: 3)
    }
