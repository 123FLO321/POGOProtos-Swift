...
public struct POGOProtos_Networking_Envelopes_Signature {
  ...
  public var field1: [POGOProtos_Networking_Envelopes_Signature.UnknownMessage] {
  ...
  public var field6: [POGOProtos_Networking_Envelopes_Signature.UnknownMessage] {
...
extension POGOProtos_Networking_Envelopes_Signature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _field1: [POGOProtos_Networking_Envelopes_Signature.UnknownMessage] = []
    ...
    var _field6: [POGOProtos_Networking_Envelopes_Signature.UnknownMessage] = []
...
extension POGOProtos_Networking_Envelopes_Signature.UnknownMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Envelopes_Signature.protoMessageName + ".UnknownMessage"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: POGOProtos_Networking_Envelopes_Signature.UnknownMessage, rhs: POGOProtos_Networking_Envelopes_Signature.UnknownMessage) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
