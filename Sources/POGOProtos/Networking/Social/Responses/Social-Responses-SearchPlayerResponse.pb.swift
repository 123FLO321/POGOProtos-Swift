...
// Source: POGOProtos/Networking/Social/Responses/SearchPlayerResponse.proto
//
...
public struct POGOProtos_Networking_Social_Responses_SearchPlayerResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Social_Responses_SearchPlayerResponse.Result {
...
extension POGOProtos_Networking_Social_Responses_SearchPlayerResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Social_Responses_SearchPlayerResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
    .errorPlayerNotFound,
...
extension POGOProtos_Networking_Social_Responses_SearchPlayerResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _result: POGOProtos_Networking_Social_Responses_SearchPlayerResponse.Result = .unset
  ...
  public static func ==(lhs: POGOProtos_Networking_Social_Responses_SearchPlayerResponse, rhs: POGOProtos_Networking_Social_Responses_SearchPlayerResponse) -> Bool {
...
extension POGOProtos_Networking_Social_Responses_SearchPlayerResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
