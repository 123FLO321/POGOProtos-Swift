...
// Source: POGOProtos/Networking/Social/Responses/ListFriendStatusResponse.proto
//
...
public struct POGOProtos_Networking_Social_Responses_ListFriendStatusResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Result = .unset

  public var friend: [POGOProtos_Data_Friends_FriendDetails] = []

  public var friendDetailsDebugInfo: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug {
    get {return _friendDetailsDebugInfo ?? POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug()}
  ...
  fileprivate var _friendDetailsDebugInfo: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug? = nil
}

#if swift(>=4.2)

extension POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
...
extension POGOProtos_Networking_Social_Responses_ListFriendStatusResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse, rhs: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse) -> Bool {
...
extension POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
...
extension POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.protoMessageName + ".Debug"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug, rhs: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug) -> Bool {
...
extension POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug.Callee: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug.protoMessageName + ".Callee"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug.Callee, rhs: POGOProtos_Networking_Social_Responses_ListFriendStatusResponse.Debug.Callee) -> Bool {
