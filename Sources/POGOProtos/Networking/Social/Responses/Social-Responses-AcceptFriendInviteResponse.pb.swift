...
// Source: POGOProtos/Networking/Social/Responses/AcceptFriendInviteResponse.proto
//
...
public struct POGOProtos_Networking_Social_Responses_AcceptFriendInviteResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Social_Responses_AcceptFriendInviteResponse.Result = .unset
...
extension POGOProtos_Networking_Social_Responses_AcceptFriendInviteResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Social_Responses_AcceptFriendInviteResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
...
extension POGOProtos_Networking_Social_Responses_AcceptFriendInviteResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Social_Responses_AcceptFriendInviteResponse, rhs: POGOProtos_Networking_Social_Responses_AcceptFriendInviteResponse) -> Bool {
...
extension POGOProtos_Networking_Social_Responses_AcceptFriendInviteResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
