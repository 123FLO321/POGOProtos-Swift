...
// Source: POGOProtos/Networking/Social/Messages/GetInboxMessage.proto
//
...
public struct POGOProtos_Networking_Social_Messages_GetInboxMessage {
...
extension POGOProtos_Networking_Social_Messages_GetInboxMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularBoolField(value: &self.isReverse)
      case 3: try decoder.decodeSingularInt64Field(value: &self.notBeforeMs)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: POGOProtos_Networking_Social_Messages_GetInboxMessage, rhs: POGOProtos_Networking_Social_Messages_GetInboxMessage) -> Bool {
