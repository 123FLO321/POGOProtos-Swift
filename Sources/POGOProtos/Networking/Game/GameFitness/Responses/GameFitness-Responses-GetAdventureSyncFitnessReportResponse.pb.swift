...
// Source: POGOProtos/Networking/Game/GameFitness/Responses/GetAdventureSyncFitnessReportResponse.proto
//
...
public struct POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncFitnessReportResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var status: POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncFitnessReportResponse.Status = .unset
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncFitnessReportResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncFitnessReportResponse.Status] = [
    .unset,
    .success,
    .errorPlayerNotFound,
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncFitnessReportResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetAdventureSyncFitnessReportResponse"
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncFitnessReportResponse, rhs: POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncFitnessReportResponse) -> Bool {
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncFitnessReportResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
