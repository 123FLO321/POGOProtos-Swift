...
// Source: POGOProtos/Networking/Game/GameFitness/Responses/GetFitnessReportResponse.proto
//
...
public struct POGOProtos_Networking_Game_GameFitness_Response_GetFitnessReportResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var status: POGOProtos_Networking_Game_GameFitness_Response_GetFitnessReportResponse.Status = .unset
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetFitnessReportResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GameFitness_Response_GetFitnessReportResponse.Status] = [
    .unset,
    .success,
    .errorPlayerNotFound,
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetFitnessReportResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameFitness_Response_GetFitnessReportResponse, rhs: POGOProtos_Networking_Game_GameFitness_Response_GetFitnessReportResponse) -> Bool {
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetFitnessReportResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
