...
// Source: POGOProtos/Networking/Game/GameFitness/Responses/GetAdventureSyncSettingsResponse.proto
//
...
public struct POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var status: POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse.Status {
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse.Status] = [
    .unset,
    .success,
    .errorUnknown,
    .errorPlayerNotFound,
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _status: POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse.Status = .unset
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse, rhs: POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse) -> Bool {
...
extension POGOProtos_Networking_Game_GameFitness_Response_GetAdventureSyncSettingsResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
