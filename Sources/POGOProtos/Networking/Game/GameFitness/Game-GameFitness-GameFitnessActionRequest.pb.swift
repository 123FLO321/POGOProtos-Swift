...
// Source: POGOProtos/Networking/Game/GameFitness/GameFitnessActionRequest.proto
//
...
public struct POGOProtos_Networking_Game_GameFitness_GameFitnessActionRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var requestType: POGOProtos_Networking_Game_GameFitness_GameFitnessAction = .unknownGameFitnessAction
...
fileprivate let _protobuf_package = "POGOProtos.Networking.Game.GameFitness"

extension POGOProtos_Networking_Game_GameFitness_GameFitnessActionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameFitness_GameFitnessActionRequest, rhs: POGOProtos_Networking_Game_GameFitness_GameFitnessActionRequest) -> Bool {
