...
// Source: POGOProtos/Networking/Game/GameAnticheat/GameAnticheatAction.proto
//
...
public enum POGOProtos_Networking_Game_GameAnticheat_GameAnticheatAction: SwiftProtobuf.Enum {
...
extension POGOProtos_Networking_Game_GameAnticheat_GameAnticheatAction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GameAnticheat_GameAnticheatAction] = [
...
extension POGOProtos_Networking_Game_GameAnticheat_GameAnticheatAction: SwiftProtobuf._ProtoNameProviding {
