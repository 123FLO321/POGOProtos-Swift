...
// Source: POGOProtos/Networking/Game/GamePing/GamePingAction.proto
//
...
public enum POGOProtos_Networking_Game_GamePing_GamePingAction: SwiftProtobuf.Enum {
...
extension POGOProtos_Networking_Game_GamePing_GamePingAction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GamePing_GamePingAction] = [
...
extension POGOProtos_Networking_Game_GamePing_GamePingAction: SwiftProtobuf._ProtoNameProviding {
