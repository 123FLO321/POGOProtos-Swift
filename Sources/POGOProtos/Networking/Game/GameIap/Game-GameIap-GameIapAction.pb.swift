...
// Source: POGOProtos/Networking/Game/GameIap/GameIapAction.proto
//
...
public enum POGOProtos_Networking_Game_GameIap_GameIapAction: SwiftProtobuf.Enum {
...
extension POGOProtos_Networking_Game_GameIap_GameIapAction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GameIap_GameIapAction] = [
...
extension POGOProtos_Networking_Game_GameIap_GameIapAction: SwiftProtobuf._ProtoNameProviding {
