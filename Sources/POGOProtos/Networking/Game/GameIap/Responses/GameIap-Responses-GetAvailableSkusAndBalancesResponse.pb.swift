...
// Source: POGOProtos/Networking/Game/GameIap/Responses/GetAvailableSkusAndBalancesResponse.proto
//
...
public struct POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var status: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.Status = .unset

  /// Items to show in the shop
  public var availableSku: [POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.AvailableSku] = []
  ...
  public struct AvailableSku {
    ...
    public var gameItemContent: [POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.GameItemContent] = []

    /// Stuff like SORT:12, CATEGORY:ITEMS
    public var presentationData: [POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.SkuPresentation] = []
...
extension POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.Status] = [
    .unset,
    .success,
    .failure,
  ]
...
fileprivate let _protobuf_package = "POGOProtos.Networking.Game.GameIap.Responses"

extension POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse, rhs: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse) -> Bool {
...
extension POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
...
extension POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.AvailableSku: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.protoMessageName + ".AvailableSku"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.AvailableSku, rhs: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.AvailableSku) -> Bool {
...
extension POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.GameItemContent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.protoMessageName + ".GameItemContent"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.GameItemContent, rhs: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.GameItemContent) -> Bool {
...
extension POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.SkuPresentation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.protoMessageName + ".SkuPresentation"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "key"),
    2: .same(proto: "value"),
  ]
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.SkuPresentation, rhs: POGOProtos_Networking_Game_GameIap_Responses_GetAvailableSkusAndBalancesResponse.SkuPresentation) -> Bool {
