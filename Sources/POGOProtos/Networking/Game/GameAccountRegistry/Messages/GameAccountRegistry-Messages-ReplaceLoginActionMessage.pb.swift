...
// Source: POGOProtos/Networking/Game/GameAccountRegistry/Messages/ReplaceLoginActionMessage.proto
//
...
public struct POGOProtos_Networking_Game_GameAccountRegistry_Messages_ReplaceLoginActionMessage {
  ...
  public var newLogin: POGOProtos_Networking_Platform_Requests_AddLoginActionMessage {
    get {return _newLogin ?? POGOProtos_Networking_Platform_Requests_AddLoginActionMessage()}
  ...
  fileprivate var _newLogin: POGOProtos_Networking_Platform_Requests_AddLoginActionMessage? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "POGOProtos.Networking.Game.GameAccountRegistry.Messages"

extension POGOProtos_Networking_Game_GameAccountRegistry_Messages_ReplaceLoginActionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GameAccountRegistry_Messages_ReplaceLoginActionMessage, rhs: POGOProtos_Networking_Game_GameAccountRegistry_Messages_ReplaceLoginActionMessage) -> Bool {
