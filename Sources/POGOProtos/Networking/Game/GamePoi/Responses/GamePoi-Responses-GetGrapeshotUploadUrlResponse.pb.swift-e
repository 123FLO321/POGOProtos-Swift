...
// Source: POGOProtos/Networking/Game/GamePoi/Responses/GetGrapeshotUploadUrlResponse.proto
//
...
public struct POGOProtos_Networking_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var status: POGOProtos_Networking_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse.Status = .unset
...
extension POGOProtos_Networking_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse.Status] = [
    .unset,
    .failure,
    .success,
    .missingFileContexts,
...
extension POGOProtos_Networking_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse, rhs: POGOProtos_Networking_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse) -> Bool {
...
extension POGOProtos_Networking_Game_GamePoi_Responses_GetGrapeshotUploadUrlResponse.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
