...
// Source: POGOProtos/Networking/Game/GamePoi/Responses/GetGmapSettingsResponse.proto
//
...
public struct POGOProtos_Networking_Game_GamePoi_Responses_GetGmapSettingsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var result: POGOProtos_Networking_Game_GamePoi_Responses_GetGmapSettingsResponse.Result = .unset
...
extension POGOProtos_Networking_Game_GamePoi_Responses_GetGmapSettingsResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Networking_Game_GamePoi_Responses_GetGmapSettingsResponse.Result] = [
    .unset,
    .success,
    .errorUnknown,
    .errorMissingConfig,
...
extension POGOProtos_Networking_Game_GamePoi_Responses_GetGmapSettingsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: POGOProtos_Networking_Game_GamePoi_Responses_GetGmapSettingsResponse, rhs: POGOProtos_Networking_Game_GamePoi_Responses_GetGmapSettingsResponse) -> Bool {
...
extension POGOProtos_Networking_Game_GamePoi_Responses_GetGmapSettingsResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
