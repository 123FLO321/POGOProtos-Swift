  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularStringField(value: &_storage._ticketID) }()
        case 2: try { try decoder.decodeSingularEnumField(value: &_storage._item) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._exclusiveInfo) }()
        default: break
        }
      }
    }
