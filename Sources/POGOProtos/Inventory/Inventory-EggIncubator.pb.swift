...
extension POGOProtos_Inventory_EggIncubator: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularEnumField(value: &self.itemID) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self.incubatorType) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.usesRemaining) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self.pokemonID) }()
      case 6: try { try decoder.decodeSingularDoubleField(value: &self.startKmWalked) }()
      case 7: try { try decoder.decodeSingularDoubleField(value: &self.targetKmWalked) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.pokemonID != 0 {
      try visitor.visitSingularInt64Field(value: self.pokemonID, fieldNumber: 5)
    }
