...
public enum POGOProtos_Enums_QuestType: SwiftProtobuf.Enum {
  ...
  case questBuddyFindSouvenir // = 40
  case questCollectAsRewards // = 41
  case questWalk // = 42
  case questMegaEvolvePokemon // = 43
  case questGetStardust // = 44
  case questGeotargetedArScan // = 46
  case questBuddyEvolutionWalk // = 50
  case questGblRank // = 51
  case questChargeAttack // = 53
  ...
  public init?(rawValue: Int) {
    ...
    case 40: self = .questBuddyFindSouvenir
    case 41: self = .questCollectAsRewards
    case 42: self = .questWalk
    case 43: self = .questMegaEvolvePokemon
    case 44: self = .questGetStardust
    case 46: self = .questGeotargetedArScan
    case 50: self = .questBuddyEvolutionWalk
    case 51: self = .questGblRank
    case 53: self = .questChargeAttack
  ...
  public var rawValue: Int {
    ...
    case .questBuddyFindSouvenir: return 40
    case .questCollectAsRewards: return 41
    case .questWalk: return 42
    case .questMegaEvolvePokemon: return 43
    case .questGetStardust: return 44
    case .questGeotargetedArScan: return 46
    case .questBuddyEvolutionWalk: return 50
    case .questGblRank: return 51
    case .questChargeAttack: return 53
...
extension POGOProtos_Enums_QuestType: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Enums_QuestType] = [
    ...
    .questBuddyYatta,
    .questUseIncense,
    .questBuddyFindSouvenir,
    .questCollectAsRewards,
    .questWalk,
    .questMegaEvolvePokemon,
    .questGetStardust,
    .questGeotargetedArScan,
    .questBuddyEvolutionWalk,
    .questGblRank,
    .questChargeAttack,
  ]
}
...
extension POGOProtos_Enums_QuestType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    40: .same(proto: "QUEST_BUDDY_FIND_SOUVENIR"),
    41: .same(proto: "QUEST_COLLECT_AS_REWARDS"),
    42: .same(proto: "QUEST_WALK"),
    43: .same(proto: "QUEST_MEGA_EVOLVE_POKEMON"),
    44: .same(proto: "QUEST_GET_STARDUST"),
    46: .same(proto: "QUEST_GEOTARGETED_AR_SCAN"),
    50: .same(proto: "QUEST_BUDDY_EVOLUTION_WALK"),
    51: .same(proto: "QUEST_GBL_RANK"),
    53: .same(proto: "QUEST_CHARGE_ATTACK"),
  ]
}
