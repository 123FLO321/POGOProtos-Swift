...
public enum POGOProtos_Enums_TutorialState: SwiftProtobuf.Enum {
  ...
  case xlCandyTutorial // = 43
  case levelUpPageTutorial // = 44
  case dailyBonusEncounterTutorial // = 45
  case sponsoredGiftTutorial // = 46
  case xgsOnlineConsentNote // = 47
  case appTrackingOptinRequiredTutorial // = 48
  case appTrackingOptinDialog // = 49
  ...
  public init?(rawValue: Int) {
    ...
    case 43: self = .xlCandyTutorial
    case 44: self = .levelUpPageTutorial
    case 45: self = .dailyBonusEncounterTutorial
    case 46: self = .sponsoredGiftTutorial
    case 47: self = .xgsOnlineConsentNote
    case 48: self = .appTrackingOptinRequiredTutorial
    case 49: self = .appTrackingOptinDialog
  ...
  public var rawValue: Int {
    ...
    case .xlCandyTutorial: return 43
    case .levelUpPageTutorial: return 44
    case .dailyBonusEncounterTutorial: return 45
    case .sponsoredGiftTutorial: return 46
    case .xgsOnlineConsentNote: return 47
    case .appTrackingOptinRequiredTutorial: return 48
    case .appTrackingOptinDialog: return 49
...
extension POGOProtos_Enums_TutorialState: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Enums_TutorialState] = [
    ...
    .appTrackingOptinRequiredTutorial,
    .appTrackingOptinDialog,
  ]
}
