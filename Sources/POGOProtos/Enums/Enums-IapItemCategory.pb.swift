...
public enum POGOProtos_Enums_HoloIapItemCategory: SwiftProtobuf.Enum {
  ...
  case iapCategorySubscription // = 14
  case iapCategoryTransporterEnergy // = 15
  ...
  public init?(rawValue: Int) {
    ...
    case 14: self = .iapCategorySubscription
    case 15: self = .iapCategoryTransporterEnergy
  ...
  public var rawValue: Int {
    ...
    case .iapCategorySubscription: return 14
    case .iapCategoryTransporterEnergy: return 15
...
extension POGOProtos_Enums_HoloIapItemCategory: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    14: .same(proto: "IAP_CATEGORY_SUBSCRIPTION"),
    15: .same(proto: "IAP_CATEGORY_TRANSPORTER_ENERGY"),
  ]
}
