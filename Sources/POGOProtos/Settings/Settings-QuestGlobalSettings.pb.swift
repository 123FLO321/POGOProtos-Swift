...
extension POGOProtos_Settings_QuestGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.enableQuests) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.maxChallengeQuests) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.enableShowSponsorName) }()
      default: break
      }
    }
  }
