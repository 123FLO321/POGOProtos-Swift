...
public struct POGOProtos_Settings_IncidentGlobalSettings {
...
extension POGOProtos_Settings_IncidentGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.minPlayerLevelForV2) }()
      default: break
      }
    }
  }
