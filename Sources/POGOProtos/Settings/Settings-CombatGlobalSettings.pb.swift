...
public struct POGOProtos_Settings_CombatGlobalSettings {
  ...
  public var enableVsSeeker: Bool {
    get {return _storage._enableVsSeeker}
    set {_uniqueStorage()._enableVsSeeker = newValue}
  }
...
extension POGOProtos_Settings_CombatGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    14: .standard(proto: "enable_vs_seeker"),
  ...
  fileprivate class _StorageClass {
    ...
    var _enableVsSeeker: Bool = false
    ...
    init(copying source: _StorageClass) {
      ...
      _enableVsSeeker = source._enableVsSeeker
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 14: try decoder.decodeSingularBoolField(value: &_storage._enableVsSeeker)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._enableVsSeeker != false {
        try visitor.visitSingularBoolField(value: _storage._enableVsSeeker, fieldNumber: 14)
      }
  ...
  public static func ==(lhs: POGOProtos_Settings_CombatGlobalSettings, rhs: POGOProtos_Settings_CombatGlobalSettings) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._enableVsSeeker != rhs_storage._enableVsSeeker {return false}
