...
public struct POGOProtos_Settings_BackgroundModeGlobalSettings {
...
extension POGOProtos_Settings_BackgroundModeGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.minPlayerLevelFitness) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.servicePromptTimestampMs) }()
      default: break
      }
    }
  }
