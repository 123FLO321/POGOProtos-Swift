...
public struct POGOProtos_Settings_PlayerSettings {
...
extension POGOProtos_Settings_PlayerSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.optOutOnlineStatus) }()
      case 2: try { try decoder.decodeRepeatedEnumField(value: &self.completedTutorials) }()
      default: break
      }
    }
  }
