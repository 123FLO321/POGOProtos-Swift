...
public struct POGOProtos_Settings_BuddyGlobalSettings {
  ...
  public var enableBuddyV2: Bool = false
...
extension POGOProtos_Settings_BuddyGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "enable_buddy_v2"),
  ]

  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBoolField(value: &self.enableBuddyV2)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.enableBuddyV2 != false {
      try visitor.visitSingularBoolField(value: self.enableBuddyV2, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: POGOProtos_Settings_BuddyGlobalSettings, rhs: POGOProtos_Settings_BuddyGlobalSettings) -> Bool {
    if lhs.enableBuddyV2 != rhs.enableBuddyV2 {return false}
