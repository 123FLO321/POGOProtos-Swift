...
extension POGOProtos_Settings_PokecoinPurchaseDisplaySettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.enabledCountries) }()
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.enabledCurrencies) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.usePokecoinPurchaseDisplayGmt) }()
      default: break
      }
    }
  }
