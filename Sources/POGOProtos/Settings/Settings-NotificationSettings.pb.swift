...
extension POGOProtos_Settings_NotificationSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.pullNotifications) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.showNotifications) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.showNotifications != false {
      try visitor.visitSingularBoolField(value: self.showNotifications, fieldNumber: 2)
    }
