...
extension POGOProtos_Settings_CombatChallengeGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.distanceCheckOverrideFriendshipLevel) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.getCombatChallengePollingIntervalSec) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.enableDownstreamDispatch) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.enableChallengeNotifications) }()
      default: break
      }
    }
  }
