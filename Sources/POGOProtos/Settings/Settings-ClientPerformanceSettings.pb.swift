...
extension POGOProtos_Settings_ClientPerformanceSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.enableLocalDiskCaching) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.maxNumberLocalBattleParties) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.multiPokemonBattlePartySelect) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.useWholeMatchForFilterKey) }()
      default: break
      }
    }
  }
