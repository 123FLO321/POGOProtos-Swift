...
extension POGOProtos_Settings_Master_VsSeekerClientSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.upgradeIapSkuID) }()
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.allowedVsSeekerLeagueTemplateID) }()
      default: break
      }
    }
  }
