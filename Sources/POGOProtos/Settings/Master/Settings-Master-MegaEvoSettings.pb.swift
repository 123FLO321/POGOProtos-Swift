...
extension POGOProtos_Settings_Master_MegaEvoSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt64Field(value: &self.evolutionLengthMs)
      case 2: try decoder.decodeSingularFloatField(value: &self.attackBoostFromMegaDifferentType)
      case 3: try decoder.decodeSingularFloatField(value: &self.attackBoostFromMegaSameType)
      case 4: try decoder.decodeSingularInt32Field(value: &self.maxCandyHoardSize)
      case 5: try decoder.decodeSingularBoolField(value: &self.enableBuddyWalkingMegaEnergyAward)
      case 6: try decoder.decodeSingularInt32Field(value: &self.activeMegaBonusCatchCandy)
      default: break
      }
    }
  }
