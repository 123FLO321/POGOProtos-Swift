...
extension POGOProtos_Settings_Master_BuddyActivitySettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.activity) }()
      case 2: try { try decoder.decodeSingularEnumField(value: &self.activityCategory) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.maxTimesPerDay) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.numPointsPerAction) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.numEmotionPointsPerAction) }()
      case 6: try { try decoder.decodeSingularInt64Field(value: &self.emotionCooldownDurationMs) }()
      default: break
      }
    }
  }
