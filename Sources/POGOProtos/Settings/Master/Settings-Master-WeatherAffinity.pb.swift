...
extension POGOProtos_Settings_Master_WeatherAffinity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.weatherCondition) }()
      case 2: try { try decoder.decodeRepeatedEnumField(value: &self.pokemonType) }()
      case 3: try { try decoder.decodeRepeatedEnumField(value: &self.weaknessPokemonType) }()
      default: break
      }
    }
  }
