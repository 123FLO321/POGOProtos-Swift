...
extension POGOProtos_Settings_Master_PokemonHomeEnergyCosts: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.pokemonClass) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.base) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.shiny) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.cp0To1000) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.cp1001To2000) }()
      case 6: try { try decoder.decodeSingularInt32Field(value: &self.cp2001ToInf) }()
      default: break
      }
    }
  }
