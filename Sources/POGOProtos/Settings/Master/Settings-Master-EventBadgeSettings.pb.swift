...
extension POGOProtos_Settings_Master_EventBadgeSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.validFromMs) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.validToMs) }()
      case 3: try { try decoder.decodeRepeatedEnumField(value: &self.mutuallyExclusiveBadges) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.automaticallyAwardBadge) }()
      default: break
      }
    }
  }
