...
extension POGOProtos_Settings_Master_GymLevelSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedInt32Field(value: &self.requiredExperience) }()
      case 2: try { try decoder.decodeRepeatedInt32Field(value: &self.leaderSlots) }()
      case 3: try { try decoder.decodeRepeatedInt32Field(value: &self.trainerSlots) }()
      case 4: try { try decoder.decodeRepeatedInt32Field(value: &self.searchRollBonus) }()
      default: break
      }
    }
  }
