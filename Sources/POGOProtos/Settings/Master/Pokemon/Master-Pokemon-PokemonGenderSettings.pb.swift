...
extension POGOProtos_Settings_Master_Pokemon_PokemonGenderSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularFloatField(value: &self.malePercent) }()
      case 2: try { try decoder.decodeSingularFloatField(value: &self.femalePercent) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.genderlessPercent) }()
      default: break
      }
    }
  }
