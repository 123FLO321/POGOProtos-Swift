...
extension POGOProtos_Settings_Master_Pokemon_StatsAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.baseStamina) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.baseAttack) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.baseDefense) }()
      case 8: try { try decoder.decodeSingularInt32Field(value: &self.dodgeEnergyDelta) }()
      default: break
      }
    }
  }
