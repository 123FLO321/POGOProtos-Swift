...
extension POGOProtos_Settings_Master_OnboardingSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.skipAvatarCustomization) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.disableInitialArPrompt) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.arPromptPlayerLevel) }()
      default: break
      }
    }
  }
