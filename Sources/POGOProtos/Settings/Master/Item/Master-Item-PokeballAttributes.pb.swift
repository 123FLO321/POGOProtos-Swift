...
extension POGOProtos_Settings_Master_Item_PokeballAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.itemEffect) }()
      case 2: try { try decoder.decodeSingularFloatField(value: &self.captureMulti) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.captureMultiEffect) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.itemEffectMod) }()
      default: break
      }
    }
  }
