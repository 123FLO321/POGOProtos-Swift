...
extension POGOProtos_Settings_Master_Item_EggIncubatorAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.incubatorType) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.uses) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.distanceMultiplier) }()
      default: break
      }
    }
  }
