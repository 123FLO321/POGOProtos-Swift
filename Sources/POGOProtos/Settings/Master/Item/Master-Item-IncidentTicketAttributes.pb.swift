...
extension POGOProtos_Settings_Master_Item_IncidentTicketAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.ignoreFullInventory) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.upgradeRequirementCount) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self.upgradedItem) }()
      default: break
      }
    }
  }
