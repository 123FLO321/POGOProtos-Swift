...
extension POGOProtos_Settings_Master_BuddyEncounterCameoSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularFloatField(value: &self.buddyWildEncounterCameoChancePercent) }()
      case 2: try { try decoder.decodeSingularFloatField(value: &self.buddyQuestEncounterCameoChancePercent) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.buddyRaidEncounterCameoChancePercent) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.buddyInvasionEncounterCameoChancePercent) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.buddyOnMapRequired) }()
      default: break
      }
    }
  }
