...
public struct POGOProtos_Settings_Master_BuddyEncounterCameoSettings {
  ...
  public var buddyEncounterCameoChancePercent: Float = 0
...
extension POGOProtos_Settings_Master_BuddyEncounterCameoSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "buddy_encounter_cameo_chance_percent"),
  ]

  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularFloatField(value: &self.buddyEncounterCameoChancePercent)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.buddyEncounterCameoChancePercent != 0 {
      try visitor.visitSingularFloatField(value: self.buddyEncounterCameoChancePercent, fieldNumber: 1)
    }
  ...
  public static func ==(lhs: POGOProtos_Settings_Master_BuddyEncounterCameoSettings, rhs: POGOProtos_Settings_Master_BuddyEncounterCameoSettings) -> Bool {
    if lhs.buddyEncounterCameoChancePercent != rhs.buddyEncounterCameoChancePercent {return false}
