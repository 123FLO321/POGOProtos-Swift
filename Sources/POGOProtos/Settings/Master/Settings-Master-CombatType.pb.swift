...
extension POGOProtos_Settings_Master_CombatType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularFloatField(value: &self.niceLevelThreshold) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.greatLevelThreshold) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.excellentLevelThreshold) }()
      default: break
      }
    }
  }
