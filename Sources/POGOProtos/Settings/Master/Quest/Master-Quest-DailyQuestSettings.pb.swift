...
extension POGOProtos_Settings_Master_Quest_DailyQuestSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.bucketsPerDay) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.streakLength) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.bonusMultiplier) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.streakBonusMultiplier) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.disable) }()
      default: break
      }
    }
  }
