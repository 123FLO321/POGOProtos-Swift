...
extension POGOProtos_Settings_Master_BuddyLevelSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.minNonCumulativePointsRequired) }()
      case 3: try { try decoder.decodeRepeatedEnumField(value: &self.unlockedTraits) }()
      default: break
      }
    }
  }
