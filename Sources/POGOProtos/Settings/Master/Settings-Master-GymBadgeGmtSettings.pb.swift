...
extension POGOProtos_Settings_Master_GymBadgeGmtSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedInt32Field(value: &self.target) }()
      case 2: try { try decoder.decodeSingularFloatField(value: &self.battleWinningScorePerDefenderCp) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.gymDefendingScorePerMinute) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.berryFeedingScore) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.pokemonDeployScore) }()
      case 6: try { try decoder.decodeSingularInt32Field(value: &self.raidBattleWinningScore) }()
      case 7: try { try decoder.decodeSingularInt32Field(value: &self.loseAllBattlesScore) }()
      default: break
      }
    }
  }
