...
extension POGOProtos_Settings_Master_PokemonScaleSetting.PokemonScaleMode: CaseIterable {
  ...
  public static var allCases: [POGOProtos_Settings_Master_PokemonScaleSetting.PokemonScaleMode] = [
    .naturalScale,
    .guiScale,
    .battlePokemonScale,
    .raidBossScale,
...
extension POGOProtos_Settings_Master_PokemonScaleSetting: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.pokemonScaleMode) }()
      case 2: try { try decoder.decodeSingularFloatField(value: &self.minHeight) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.maxHeight) }()
      default: break
      }
    }
  }
