...
extension POGOProtos_Settings_Master_FriendshipLevelMilestoneSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.minPointsToReach) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.milestoneXpReward) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.attackBonusPercentage) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.raidBallBonus) }()
      case 5: try { try decoder.decodeRepeatedEnumField(value: &self.unlockedTrading) }()
      case 6: try { try decoder.decodeSingularFloatField(value: &self.tradingDiscount) }()
      default: break
      }
    }
  }
