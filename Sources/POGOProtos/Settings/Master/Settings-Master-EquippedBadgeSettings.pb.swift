...
extension POGOProtos_Settings_Master_EquippedBadgeSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.equipBadgeCooldownMs) }()
      case 2: try { try decoder.decodeRepeatedFloatField(value: &self.catchProbabilityBonus) }()
      case 3: try { try decoder.decodeRepeatedFloatField(value: &self.fleeProbabilityBonus) }()
      default: break
      }
    }
  }
