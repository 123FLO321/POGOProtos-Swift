...
extension POGOProtos_Settings_MapSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularDoubleField(value: &self.pokemonVisibleRange) }()
      case 2: try { try decoder.decodeSingularDoubleField(value: &self.pokeNavRangeMeters) }()
      case 3: try { try decoder.decodeSingularDoubleField(value: &self.encounterRangeMeters) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.getMapObjectsMinRefreshSeconds) }()
      case 5: try { try decoder.decodeSingularFloatField(value: &self.getMapObjectsMaxRefreshSeconds) }()
      case 6: try { try decoder.decodeSingularFloatField(value: &self.getMapObjectsMinDistanceMeters) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.googleMapsApiKey) }()
      case 8: try { try decoder.decodeSingularInt32Field(value: &self.minNearbyHideSightings) }()
      case 9: try { try decoder.decodeSingularBoolField(value: &self.enableSpecialWeather) }()
      case 10: try { try decoder.decodeSingularFloatField(value: &self.specialWeatherProbability) }()
      case 11: try { try decoder.decodeSingularStringField(value: &self.googleMapsClientID) }()
      case 12: try { try decoder.decodeSingularBoolField(value: &self.enableEncounterV2) }()
      default: break
      }
    }
  }
