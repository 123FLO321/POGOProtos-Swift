...
extension POGOProtos_Settings_EventSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedStringField(value: &self.condolenceRibbonCountry) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.enableEventLink) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.enableEventLinkForChildren) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.eventWebtokenServerURL) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.enableEventLnt) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.eventLntURL) }()
      default: break
      }
    }
  }
