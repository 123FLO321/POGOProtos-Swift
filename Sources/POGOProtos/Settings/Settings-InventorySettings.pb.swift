...
extension POGOProtos_Settings_InventorySettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.maxPokemon) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.maxBagItems) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.basePokemon) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.baseBagItems) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.baseEggs) }()
      case 6: try { try decoder.decodeSingularInt32Field(value: &self.maxTeamChanges) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.teamChangeItemResetPeriodInDays) }()
      case 8: try { try decoder.decodeSingularInt64Field(value: &self.maxItemBoostDurationMs) }()
      case 9: try { try decoder.decodeSingularInt32Field(value: &self.defaultStickerMaxCount) }()
      default: break
      }
    }
  }
