...
extension POGOProtos_Settings_PlannedDowntimeSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.downtimeTimestampMs) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.noActionsWindowSecFromDowntime) }()
      default: break
      }
    }
  }
