...
public struct POGOProtos_Tools_AssetDigestDecoderTool {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var digest: [POGOProtos_Tools_AssetDigestDecoderTool.AssetDigestEntry] = []

  public var timestampMs: UInt64 = 0

  public var result: POGOProtos_Tools_AssetDigestDecoderTool.Result = .unset
...
extension POGOProtos_Tools_AssetDigestDecoderTool.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [POGOProtos_Tools_AssetDigestDecoderTool.Result] = [
    .unset,
    .success,
    .page,
    .retry,
...
extension POGOProtos_Tools_AssetDigestDecoderTool: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AssetDigestDecoderTool"
  ...
  public static func ==(lhs: POGOProtos_Tools_AssetDigestDecoderTool, rhs: POGOProtos_Tools_AssetDigestDecoderTool) -> Bool {
...
extension POGOProtos_Tools_AssetDigestDecoderTool.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
...
extension POGOProtos_Tools_AssetDigestDecoderTool.AssetDigestEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = POGOProtos_Tools_AssetDigestDecoderTool.protoMessageName + ".AssetDigestEntry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: POGOProtos_Tools_AssetDigestDecoderTool.AssetDigestEntry, rhs: POGOProtos_Tools_AssetDigestDecoderTool.AssetDigestEntry) -> Bool {
