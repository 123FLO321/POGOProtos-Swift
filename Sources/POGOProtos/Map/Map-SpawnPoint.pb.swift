...
public struct POGOProtos_Map_SpawnPoint {
...
extension POGOProtos_Map_SpawnPoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SpawnPoint"
  ...
  public static func ==(lhs: POGOProtos_Map_SpawnPoint, rhs: POGOProtos_Map_SpawnPoint) -> Bool {
