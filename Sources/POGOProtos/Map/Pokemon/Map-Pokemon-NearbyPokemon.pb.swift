  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularFloatField(value: &_storage._distanceInMeters) }()
        case 3: try { try decoder.decodeSingularFixed64Field(value: &_storage._encounterID) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._fortID) }()
        case 5: try { try decoder.decodeSingularStringField(value: &_storage._fortImageURL) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._pokemonDisplay) }()
        default: break
        }
      }
    }
