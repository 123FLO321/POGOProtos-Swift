...
extension POGOProtos_Map_Pokemon_WildPokemon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.lastModifiedTimestampMs) }()
      ...
      case 7: try { try decoder.decodeSingularMessageField(value: &self._pokemonData) }()
      case 11: try { try decoder.decodeSingularInt32Field(value: &self.timeTillHiddenMs) }()
      default: break
      }
    }
  }
