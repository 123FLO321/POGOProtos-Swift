...
extension POGOProtos_Map_Pokemon_LobbyPokemon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularEnumField(value: &self.pokedexID) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.cp) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.percentHealth) }()
      default: break
      }
    }
  }
