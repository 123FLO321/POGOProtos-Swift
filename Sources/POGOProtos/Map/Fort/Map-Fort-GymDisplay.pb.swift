...
extension POGOProtos_Map_Fort_GymDisplay: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.gymEvent) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.totalGymCp) }()
      case 3: try { try decoder.decodeSingularDoubleField(value: &self.lowestPokemonMotivation) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.slotsAvailable) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self.occupiedMillis) }()
      default: break
      }
    }
  }
