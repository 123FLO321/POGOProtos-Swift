...
extension POGOProtos_Map_Fort_GymEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.trainer) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.timestampMs) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self.event) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.pokedexID) }()
      case 5: try { try decoder.decodeSingularFixed64Field(value: &self.pokemonID) }()
      default: break
      }
    }
  }
