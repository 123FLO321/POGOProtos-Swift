...
extension POGOProtos_Map_Fort_SponsoredDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedStringField(value: &self.promoImageURL) }()
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.promoDescription) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.callToActionLink) }()
      case 4: try { try decoder.decodeSingularEnumField(value: &self.promoButtonMessageType) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.campaignID) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._promoImageCreative) }()
      default: break
      }
    }
  }
...
extension POGOProtos_Map_Fort_SponsoredDetails.ImageTextCreative: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self.previewImageURL) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.fullscreenImageURL) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.ctaLink) }()
      default: break
      }
    }
  }
